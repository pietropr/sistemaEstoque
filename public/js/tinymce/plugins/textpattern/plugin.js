...
var textpattern = (function () {
  ...
  var $_61kvtertjkbnba73 = { getPatterns: getPatterns };
  ...
  var patternFromRng = function (patterns, rng, space) {
    ...
    var endPattern = $_2mo3prs1jkbnba7z.findEndPattern(patterns, text, rng.startOffset, delta);
    ...
    var startPattern = $_2mo3prs1jkbnba7z.findPattern(patterns, patternRng.toString());
  ...
  var applyBlockFormat = function (editor, patterns) {
    ...
    if (textBlockElm) {
      ...
      if (firstTextNode) {
        pattern = $_2mo3prs1jkbnba7z.findPattern(patterns, firstTextNode.data);
        if (!pattern) {
          return;
        }
  ...
  function handleEnter(editor, patterns) {
    ...
    wrappedTextNode = $_9emruvryjkbnba7n.applyInlineFormatEnter(editor, patterns);
    if (wrappedTextNode) {
    ...
    $_9emruvryjkbnba7n.applyBlockFormat(editor, patterns);
  }
  function handleInlineKey(editor, patterns) {
    var wrappedTextNode, lastChar, lastCharNode, rng, dom;
    wrappedTextNode = $_9emruvryjkbnba7n.applyInlineFormatSpace(editor, patterns);
    if (wrappedTextNode) {
      dom = editor.dom;
  ...
  var setup = function (editor, patternsState) {
    ...
    editor.on('keydown', function (e) {
      if (e.keyCode === 13 && !global$2.modifierPressed(e)) {
        $_8djdxyrxjkbnba7f.handleEnter(editor, patternsState.get());
      }
    }, true);
    editor.on('keyup', function (e) {
      if ($_8djdxyrxjkbnba7f.checkKeyCode(keyCodes, e)) {
        $_8djdxyrxjkbnba7f.handleInlineKey(editor, patternsState.get());
      }
    });
    editor.on('keypress', function (e) {
      if ($_8djdxyrxjkbnba7f.checkCharCode(charCodes, e)) {
  ...
  var $_b2lw9rrujkbnba78 = { setup: setup };

  global.add('textpattern', function (editor) {
    var patternsState = Cell($_61kvtertjkbnba73.getPatterns(editor.settings));
    $_b2lw9rrujkbnba78.setup(editor, patternsState);
    return $_68ny2zrsjkbnba6v.get(patternsState);
  });
  function Plugin () {
  }
