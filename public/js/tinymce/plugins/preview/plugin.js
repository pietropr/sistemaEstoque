...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_337dm3jfjkbnb5uo.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_337dm3jfjkbnb5uo.getPreviewDialogWidth(editor);
    var dialogHeight = $_337dm3jfjkbnb5uo.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_en4rd7jgjkbnb5v3.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_g9woagjdjkbnb5tw = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_g9woagjdjkbnb5tw.open(editor);
    });
  };
  var $_dreomojcjkbnb5tt = { register: register };
  ...
  var $_7rvngajijkbnb5va = { register: register$1 };

  global.add('preview', function (editor) {
    $_dreomojcjkbnb5tt.register(editor);
    $_7rvngajijkbnb5va.register(editor);
  });
  function Plugin () {
  }
