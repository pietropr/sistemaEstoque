...
var spellchecker = (function () {
  ...
  var $_2v193qk8jkbnb64u = { hasProPlugin: hasProPlugin };
  ...
  var defaultSpellcheckCallback = function (editor, pluginUrl, currentLanguageState) {
    return function (method, text, doneCallback, errorCallback) {
      ...
      global$3.send({
        url: new global$2(pluginUrl).toAbsolute($_gitudpkbjkbnb661.getRpcUrl(editor)),
        type: 'post',
        ...
        error: function () {
          var message = editor.translate('The spelling service was not found: (') + $_gitudpkbjkbnb661.getRpcUrl(editor) + editor.translate(')');
          errorCallback(message);
        }
      });
    };
  ...
  var sendRpcCall = function (editor, pluginUrl, currentLanguageState, name, data, successCallback, errorCallback) {
    var userSpellcheckCallback = $_gitudpkbjkbnb661.getSpellcheckerCallback(editor);
  ...
  var finish = function (editor, startedState, textMatcherState) {
    ...
    if (startedState.get()) {
      ...
      $_584rnykgjkbnb66h.fireSpellcheckEnd(editor);
      return true;
    }
  };
  ...
  var markErrors = function (editor, startedState, textMatcherState, lastSuggestionsState, data) {
    ...
    getTextMatcher(editor, textMatcherState).find($_gitudpkbjkbnb661.getSpellcheckerWordcharPattern(editor)).filter(function (match) {
    ...
    $_584rnykgjkbnb66h.fireSpellcheckStart(editor);
  };
  var $_5ojwv5kcjkbnb666 = {
  ...
  var get = function (editor, startedState, lastSuggestionsState, textMatcherState, currentLanguageState, url) {
    ...
    var getWordCharPattern = function () {
      return $_gitudpkbjkbnb661.getSpellcheckerWordcharPattern(editor);
    };
    var markErrors = function (data) {
      $_5ojwv5kcjkbnb666.markErrors(editor, startedState, textMatcherState, lastSuggestionsState, data);
    };
  ...
  var $_1ifp6mkajkbnb65q = { get: get };

  var register = function (editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState) {
    editor.addCommand('mceSpellCheck', function () {
      $_5ojwv5kcjkbnb666.spellcheck(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
    });
  };
  var $_5tie0wkijkbnb673 = { register: register };
  ...
  var getItems = function (editor) {
    return global$1.map($_gitudpkbjkbnb661.getLanguages(editor).split(','), function (langPair) {
  ...
  var $_e0p5rqkjjkbnb679 = { register: register$1 };
  ...
  var showSuggestions = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState, word, spans) {
    ...
    global$1.each(suggestions, function (suggestion) {
      items.push({
        ...
        onclick: function () {
          ...
          $_5ojwv5kcjkbnb666.checkIfFinished(editor, startedState, textMatcherState);
        }
      });
    });
    items.push({ text: '-' });
    ...
    if (hasDictionarySupport) {
      items.push({
        ...
        onclick: function () {
          $_5ojwv5kcjkbnb666.addToDictionary(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, word, spans);
        }
      });
    }
    items.push.apply(items, [
      {
        text: 'Ignore',
        onclick: function () {
          $_5ojwv5kcjkbnb666.ignoreWord(editor, startedState, textMatcherState, word, spans);
        }
      },
      {
        text: 'Ignore all',
        onclick: function () {
          $_5ojwv5kcjkbnb666.ignoreWord(editor, startedState, textMatcherState, word, spans, true);
        }
      }
    ]);
  ...
  var setup = function (editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState) {
    editor.on('click', function (e) {
      ...
      if (target.className === 'mce-spellchecker-word') {
        e.preventDefault();
        var spans = $_5ojwv5kcjkbnb666.findSpansByIndex(editor, $_5ojwv5kcjkbnb666.getElmIndex(target));
        if (spans.length > 0) {
          var rng = editor.dom.createRng();
  ...
  var $_63bl6vkkjkbnb67e = { setup: setup };

  global.add('spellchecker', function (editor, pluginUrl) {
    if ($_2v193qk8jkbnb64u.hasProPlugin(editor) === false) {
      var startedState = Cell(false);
      var currentLanguageState = Cell($_gitudpkbjkbnb661.getLanguage(editor));
      var textMatcherState = Cell(null);
      var lastSuggestionsState = Cell(null);
      $_e0p5rqkjjkbnb679.register(editor, pluginUrl, startedState, textMatcherState, currentLanguageState, lastSuggestionsState);
      $_63bl6vkkjkbnb67e.setup(editor, pluginUrl, lastSuggestionsState, startedState, textMatcherState, currentLanguageState);
      $_5tie0wkijkbnb673.register(editor, pluginUrl, startedState, textMatcherState, lastSuggestionsState, currentLanguageState);
      return $_1ifp6mkajkbnb65q.get(editor, startedState, lastSuggestionsState, textMatcherState, currentLanguageState, pluginUrl);
    }
  });
  function Plugin () {
  }
