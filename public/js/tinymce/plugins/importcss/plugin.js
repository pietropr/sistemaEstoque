...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_8uuzeafcjkbnb4yo.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_8uuzeafcjkbnb4yo.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_8uuzeafcjkbnb4yo.getSelectorConverter(editor)) {
      selectorConverter = $_8uuzeafcjkbnb4yo.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_8uuzeafcjkbnb4yo.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_8uuzeafcjkbnb4yo.getCssGroups(editor));
      ...
      if (!$_8uuzeafcjkbnb4yo.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_8uuzeafcjkbnb4yo.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_iy9cuf7jkbnb4yb.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_333ddpf6jkbnb4y6 = { get: get };

  global.add('importcss', function (editor) {
    $_iy9cuf7jkbnb4yb.setup(editor);
    return $_333ddpf6jkbnb4y6.get(editor);
  });
  function Plugin () {
  }
