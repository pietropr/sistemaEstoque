...
var contextmenu = (function () {
  ...
  var $_260348avjkbnb3uj = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_el5ujlaujkbnb3ub.getContextMenu(editor);
  ...
  var $_565gqfayjkbnb3uv = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_el5ujlaujkbnb3ub.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_565gqfayjkbnb3uv.show(editor, $_260348avjkbnb3uj.getPos(editor, e), visibleState, menu);
    });
  };
  var $_g3ndsuatjkbnb3u6 = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_g3ndsuatjkbnb3u6.setup(editor, visibleState, menu);
    return $_5m658pasjkbnb3u3.get(visibleState);
  });
  function Plugin () {
  }
