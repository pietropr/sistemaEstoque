...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_9w6s1xagjkbnb3qi.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_1vfer1abjkbnb3o5.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_723fntadjkbnb3o9.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_fjwv39ahjkbnb3ql = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_5oau73aajkbnb3o2 = {
    open: function (editor) {
      var minWidth = $_1vfer1abjkbnb3o5.getDialogMinWidth(editor);
      var minHeight = $_1vfer1abjkbnb3o5.getDialogMinHeight(editor);
      var currentLanguage = $_fjwv39ahjkbnb3ql.getCurrentLanguage(editor);
      var currentLanguages = $_fjwv39ahjkbnb3ql.getLanguages(editor);
      var currentCode = $_723fntadjkbnb3o9.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_723fntadjkbnb3o9.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_9w6s1xagjkbnb3qi.isCodeSample(node)) {
        $_5oau73aajkbnb3o2.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_8bug7ba9jkbnb3o0 = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_9w6s1xagjkbnb3qi.trimArg($_9w6s1xagjkbnb3qi.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_9w6s1xagjkbnb3qi.trimArg($_9w6s1xagjkbnb3qi.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_4z6h7taijkbnb3qo = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_1vfer1abjkbnb3o5.getContentCss(editor);
  ...
  var $_30rn8wajjkbnb3qs = { loadCss: loadCss };
  ...
  var $_buzr1cakjkbnb3qv = { register: register$1 };

  var addedInlineCss = Cell(false);
  global.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_4z6h7taijkbnb3qo.setup(editor);
    $_buzr1cakjkbnb3qv.register(editor);
    $_8bug7ba9jkbnb3o0.register(editor);
    editor.on('init', function () {
      $_30rn8wajjkbnb3qs.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_9w6s1xagjkbnb3qi.isCodeSample(ev.target)) {
        $_5oau73aajkbnb3o2.open(editor);
      }
    });
  });
