...
var emoticons = (function () {
  ...
  var $_79iscpbajkbnb3wl = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_79iscpbajkbnb3wl.getHtml(pluginUrl);
  ...
  var $_f9x3qib9jkbnb3wh = { register: register };

  global.add('emoticons', function (editor, pluginUrl) {
    $_f9x3qib9jkbnb3wh.register(editor, pluginUrl);
  });
  function Plugin () {
  }
