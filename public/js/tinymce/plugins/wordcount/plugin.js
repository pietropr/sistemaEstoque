...
var wordcount = (function () {
  ...
  var $_c2cwzxtjjkbnbam1 = {
    each: each,
    map: map
  };

  var SETS$1 = $_dniapxthjkbnbalg.SETS;
  var OTHER = $_dniapxthjkbnbalg.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_c2cwzxtjjkbnbam1.map(string.split(''), memoized);
  };
  var $_dvjiodtijkbnbalv = { classify: classify };

  var ci = $_dniapxthjkbnbalg.characterIndices;
  ...
  var $_5unh9gtkjkbnbamc = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_dniapxthjkbnbalg.EMPTY_STRING;
  var WHITESPACE$1 = $_dniapxthjkbnbalg.WHITESPACE;
  var PUNCTUATION$1 = $_dniapxthjkbnbalg.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_dvjiodtijkbnbalv.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_5unh9gtkjkbnbamc.isWordBoundary(map, i)) {
  ...
  var $_ckyez7tgjkbnbakj = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_ckyez7tgjkbnbakj.getWords(getTextContent(editor)).length;
  };
  var $_70o4u1tfjkbnbakc = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_70o4u1tfjkbnbakc.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_c00paetejkbnbak6 = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_70o4u1tfjkbnbakc.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_2xduswtljkbnbaml = { setup: setup };

  global.add('wordcount', function (editor) {
    $_2xduswtljkbnbaml.setup(editor);
    return $_c00paetejkbnbak6.get(editor);
  });
  function Plugin () {
  }
