...
var help = (function () {
  ...
  var $_evzgf0bmjkbnb3yb = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = map($_evzgf0bmjkbnb3yb.shortcuts, function (shortcut) {
  ...
  var $_2j9cp4bgjkbnb3xc = { makeTab: makeTab };
  ...
  var $_450b9ubojkbnb3yg = { makeTab: makeTab$1 };
  ...
  var $_98a0lybujkbnb3ze = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_2j9cp4bgjkbnb3xc.makeTab(),
          $_450b9ubojkbnb3yg.makeTab(editor)
        ],
        buttons: $_98a0lybujkbnb3ze.makeRow(),
  ...
  var $_bpdkoxbfjkbnb3x9 = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_bpdkoxbfjkbnb3x9.open(editor, pluginUrl));
  };
  var $_816f40bejkbnb3x7 = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_bpdkoxbfjkbnb3x9.open(editor, pluginUrl)
    });
  ...
  var $_bou95sbwjkbnb3zi = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_bou95sbwjkbnb3zi.register(editor, pluginUrl);
    $_816f40bejkbnb3x7.register(editor, pluginUrl);
