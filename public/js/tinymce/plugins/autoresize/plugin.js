...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_936e2493jkbnb3fr.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_936e2493jkbnb3fr.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_936e2493jkbnb3fr.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_936e2493jkbnb3fr.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_936e2493jkbnb3fr.getAutoResizeBottomMargin(editor);
    ...
    if ($_936e2493jkbnb3fr.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_e8w9us90jkbnb3fj.resize(editor, oldSize);
    });
  };
  var $_b97ktt8zjkbnb3fe = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_b97ktt8zjkbnb3fe.register(editor, oldSize);
      $_e8w9us90jkbnb3fj.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
