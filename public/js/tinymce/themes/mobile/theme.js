...
var mobile = (function () {
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_1cvitey7jkbnbck1.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_1cvitey7jkbnbck1.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_1cvitey7jkbnbck1.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_fqhdrjycjkbnbcle = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_fqhdrjycjkbnbcle.browsers();
    var oses = $_fqhdrjycjkbnbcle.oses();
    var browser = $_eo381myajkbnbckl.detectBrowser(browsers, userAgent).fold($_17cu7yy6jkbnbcjq.unknown, $_17cu7yy6jkbnbcjq.nu);
    var os = $_eo381myajkbnbckl.detectOs(oses, userAgent).fold($_d40eucy8jkbnbck4.unknown, $_d40eucy8jkbnbck4.nu);
  ...
  var $_4k0a33y5jkbnbcjn = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_4k0a33y5jkbnbcjn.detect(userAgent);
  });
  var $_gfn29ky3jkbnbcjc = { detect: detect$3 };
  ...
  var tap = alloy.tap;
  var tapOrClick = $_gfn29ky3jkbnbcjc.detect().deviceType.isTouch() ? alloy.tap : click;
  ...
  var isComment = function (element) {
    return type(element) === $_7f60esyljkbnbcom.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_7f60esyljkbnbcom.ELEMENT);
  var isText = isType$1($_7f60esyljkbnbcom.TEXT);
  var isDocument = isType$1($_7f60esyljkbnbcom.DOCUMENT);
  var $_391003ykjkbnbcok = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_391003ykjkbnbcok.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_3sf7h0ysjkbnbcq1 = { toArray: toArray };
  ...
  var $_cf6yy1yvjkbnbcrf = { getOrDie: getOrDie };

  var node = function () {
    var f = $_cf6yy1yvjkbnbcrf.getOrDie('Node');
    return f;
  };
  ...
  var $_189k4kyujkbnbcrd = {
    documentPositionPreceding: documentPositionPreceding,
    documentPositionContainedBy: documentPositionContainedBy
  };

  var ELEMENT = $_7f60esyljkbnbcom.ELEMENT;
  var DOCUMENT = $_7f60esyljkbnbcom.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_189k4kyujkbnbcrd.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_gfn29ky3jkbnbcjc.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_3nd6p8ytjkbnbcq4 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_dgipdcyyjkbnbcrr.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_3nd6p8ytjkbnbcq4.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_3nd6p8ytjkbnbcq4.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_3sf7h0ysjkbnbcq1.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_3sf7h0ysjkbnbcq1.toArray(element, nextSibling);
  };
  ...
  var before = function (marker, element) {
    var parent = $_xmnonynjkbnbcov.parent(marker);
    parent.each(function (v) {
      v.dom().insertBefore(element.dom(), marker.dom());
    });
  };
  var after = function (marker, element) {
    var sibling = $_xmnonynjkbnbcov.nextSibling(marker);
  ...
  var prepend = function (parent, element) {
    var firstChild = $_xmnonynjkbnbcov.firstChild(parent);
  ...
  var appendAt = function (parent, element, index) {
    $_xmnonynjkbnbcov.child(parent, index).fold(function () {
      append(parent, element);
    }, function (v) {
      before(v, element);
    });
  ...
  var before$1 = function (marker, elements) {
    each$1(elements, function (x) {
      $_4k9tcqymjkbnbcor.before(marker, x);
    });
  };
  var after$1 = function (marker, elements) {
    each$1(elements, function (x, i) {
      var e = i === 0 ? marker : elements[i - 1];
      $_4k9tcqymjkbnbcor.after(e, x);
    });
  };
  var prepend$1 = function (parent, elements) {
    each$1(elements.slice().reverse(), function (x) {
      $_4k9tcqymjkbnbcor.prepend(parent, x);
    });
  };
  var append$1 = function (parent, elements) {
    each$1(elements, function (x) {
      $_4k9tcqymjkbnbcor.append(parent, x);
    });
  };
  var $_abel80z0jkbnbcsb = {
    before: before$1,
    after: after$1,
    prepend: prepend$1,
    append: append$1
  ...
  var empty = function (element) {
    ...
    each$1($_xmnonynjkbnbcov.children(element), function (rogue) {
      remove(rogue);
    });
  };
  ...
  var unwrap = function (wrapper) {
    var children = $_xmnonynjkbnbcov.children(wrapper);
    if (children.length > 0)
      $_abel80z0jkbnbcsb.before(wrapper, children);
    remove(wrapper);
  };
  var $_9sor8jyzjkbnbcs4 = {
    empty: empty,
    remove: remove,
    unwrap: unwrap
  };
  ...
  var attach = function (parent, child) {
    attachWith(parent, child, $_4k9tcqymjkbnbcor.append);
  };
  var attachWith = function (parent, child, insertion) {
    parent.getSystem().addToWorld(child);
    insertion(parent.element(), child.element());
    if ($_bm7r6hyhjkbnbcnh.inBody(parent.element())) {
      fireAttaching(child);
    }
  ...
  var doDetach = function (component) {
    ...
    $_9sor8jyzjkbnbcs4.remove(component.element());
    component.getSystem().removeFromWorld(component);
  };
  var detach = function (component) {
    var parent = $_xmnonynjkbnbcov.parent(component.element()).bind(function (p) {
  ...
  var detachChildren = function (component) {
    ...
    $_9sor8jyzjkbnbcs4.empty(component.element());
    component.syncComponents();
  };
  var attachSystem = function (element, guiSystem) {
    $_4k9tcqymjkbnbcor.append(element, guiSystem.element());
    var children = $_xmnonynjkbnbcov.children(guiSystem.element());
  ...
  var json = function () {
    return $_cf6yy1yvjkbnbcrf.getOrDie('JSON');
  };
  ...
  var $_g9lk3czhjkbnbcxq = {
    parse: parse,
    stringify: stringify
  };

  var formatObj = function (input) {
    return isObject(input) && keys(input).length > 100 ? ' removed due to size' : $_g9lk3czhjkbnbcxq.stringify(input, null, 2);
  };
  ...
  var isSource = function (component, simulatedEvent) {
    return $_3nd6p8ytjkbnbcq4.eq(component.element(), simulatedEvent.event().target());
  };

  var nu$4 = function (parts) {
    if (!hasKey$1(parts, 'can') && !hasKey$1(parts, 'abort') && !hasKey$1(parts, 'run')) {
      throw new Error('EventHandler defined by: ' + $_g9lk3czhjkbnbcxq.stringify(parts, null, 2) + ' does not have can, abort, or run!');
    }
  ...
  var defToStr = function (defn) {
    ...
    return $_g9lk3czhjkbnbcxq.stringify(raw, null, 2);
  };
  var defToRaw = function (defn) {
    return {
      ...
      defChildren: defn.defChildren().fold(function () {
        ...
        return $_g9lk3czhjkbnbcxq.stringify(d, null, 2);
      }),
  ...
  var transfer = function (source, destination, attrs) {
    if (!$_391003ykjkbnbcok.isElement(source) || !$_391003ykjkbnbcok.isElement(destination))
      return;
    each$1(attrs, function (attr) {
      transferOne(source, destination, attr);
    });
  };
  var $_elmynfzwjkbnbd3c = {
    clone: clone,
    set: set,
    setAll: setAll,
    get: get,
  ...
  var read$1 = function (element, attr) {
    var value = $_elmynfzwjkbnbd3c.get(element, attr);
    return value === undefined || value === '' ? [] : value.split(' ');
  };
  var add = function (element, attr, id) {
    var old = read$1(element, attr);
    var nu = old.concat([id]);
    $_elmynfzwjkbnbd3c.set(element, attr, nu.join(' '));
    return true;
  };
  var remove$2 = function (element, attr, id) {
    ...
    if (nu.length > 0)
      ...
      $_elmynfzwjkbnbd3c.remove(element, attr);
    return false;
  };
  var $_esxgyxzyjkbnbd42 = {
    read: read$1,
    add: add,
    remove: remove$2
  };
  ...
  var get$1 = function (element) {
    return $_esxgyxzyjkbnbd42.read(element, 'class');
  };
  var add$1 = function (element, clazz) {
    return $_esxgyxzyjkbnbd42.add(element, 'class', clazz);
  };
  var remove$3 = function (element, clazz) {
    return $_esxgyxzyjkbnbd42.remove(element, 'class', clazz);
  };
  ...
  var add$2 = function (element, clazz) {
    if ($_4lgitfzxjkbnbd3v.supports(element))
      element.dom().classList.add(clazz);
    else
      $_4lgitfzxjkbnbd3v.add(element, clazz);
  };
  var cleanClass = function (element) {
    var classList = $_4lgitfzxjkbnbd3v.supports(element) ? element.dom().classList : $_4lgitfzxjkbnbd3v.get(element);
    if (classList.length === 0) {
      $_elmynfzwjkbnbd3c.remove(element, 'class');
    }
  };
  var remove$4 = function (element, clazz) {
    if ($_4lgitfzxjkbnbd3v.supports(element)) {
      ...
      $_4lgitfzxjkbnbd3v.remove(element, clazz);
    cleanClass(element);
  };
  var toggle$1 = function (element, clazz) {
    return $_4lgitfzxjkbnbd3v.supports(element) ? element.dom().classList.toggle(clazz) : $_4lgitfzxjkbnbd3v.toggle(element, clazz);
  };
  var toggler = function (element, clazz) {
    var hasClasslist = $_4lgitfzxjkbnbd3v.supports(element);
    var classList = element.dom().classList;
    var off = function () {
      if (hasClasslist)
        classList.remove(clazz);
  ...
  var has$1 = function (element, clazz) {
    return $_4lgitfzxjkbnbd3v.supports(element) && element.dom().classList.contains(clazz);
  };
  var $_27wkbdzujkbnbd36 = {
    add: add$2,
    remove: remove$4,
    toggle: toggle$1,
    toggler: toggler,
  ...
  var swap = function (element, addCls, removeCls) {
    $_27wkbdzujkbnbd36.remove(element, removeCls);
    $_27wkbdzujkbnbd36.add(element, addCls);
  };
  ...
  var clear = function (component, swapConfig, swapState) {
    $_27wkbdzujkbnbd36.remove(component.element(), swapConfig.alpha());
    $_27wkbdzujkbnbd36.remove(component.element(), swapConfig.omega());
  };
  var isAlpha = function (component, swapConfig, swapState) {
    return $_27wkbdzujkbnbd36.has(component.element(), swapConfig.alpha());
  };
  var isOmega = function (component, swapConfig, swapState) {
    return $_27wkbdzujkbnbd36.has(component.element(), swapConfig.omega());
  };
  ...
  var first$1 = function (predicate) {
    return descendant($_bm7r6hyhjkbnbcnh.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_3nd6p8ytjkbnbcq4.eq(scope, x) && predicate(x);
    });
  };
  ...
  var any$1 = function (predicate) {
    return $_c6nan6103jkbnbd52.first(predicate).isSome();
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    return $_c6nan6103jkbnbd52.ancestor(scope, predicate, isRoot).isSome();
  };
  var closest$1 = function (scope, predicate, isRoot) {
    return $_c6nan6103jkbnbd52.closest(scope, predicate, isRoot).isSome();
  };
  var sibling$1 = function (scope, predicate) {
    return $_c6nan6103jkbnbd52.sibling(scope, predicate).isSome();
  };
  var child$2 = function (scope, predicate) {
    return $_c6nan6103jkbnbd52.child(scope, predicate).isSome();
  };
  var descendant$1 = function (scope, predicate) {
    return $_c6nan6103jkbnbd52.descendant(scope, predicate).isSome();
  };
  var $_ddmpcx102jkbnbd4y = {
    any: any$1,
    ancestor: ancestor$1,
    closest: closest$1,
    sibling: sibling$1,
  ...
  var hasFocus = function (element) {
    var doc = $_xmnonynjkbnbcov.owner(element).dom();
  ...
  var focusInside = function (element) {
    var doc = $_xmnonynjkbnbcov.owner(element);
    var inside = active(doc).filter(function (a) {
      return $_ddmpcx102jkbnbd4y.closest(a, curry($_3nd6p8ytjkbnbcq4.eq, element));
    });
  ...
  var search = function (element) {
    return active($_xmnonynjkbnbcov.owner(element)).filter(function (e) {
      return element.dom().contains(e.dom());
    });
  };
  var $_1jph6e101jkbnbd4i = {
    hasFocus: hasFocus,
    focus: focus$2,
    blur: blur$$1,
    active: active,
  ...
  var $_fwvusz107jkbnbd62 = { openLink: openLink };
  ...
  var fromHtml$1 = function (html, scope) {
    ...
    var div = doc.createElement('div');
    div.innerHTML = html;
    return $_xmnonynjkbnbcov.children(Element$$1.fromDom(div));
  };
  ...
  var set$1 = function (element, content) {
    var owner = $_xmnonynjkbnbcov.owner(element);
    var docDom = owner.dom();
    var fragment = Element$$1.fromDom(docDom.createDocumentFragment());
    var contentElements = $_5kg6zj10gjkbnbd8c.fromHtml(content, docDom);
    $_abel80z0jkbnbcsb.append(fragment, contentElements);
    $_9sor8jyzjkbnbcs4.empty(element);
    $_4k9tcqymjkbnbcor.append(element, fragment);
  };
  var getOuter = function (element) {
    var container = Element$$1.fromTag('div');
    var clone = Element$$1.fromDom(element.dom().cloneNode(true));
    $_4k9tcqymjkbnbcor.append(container, clone);
    return get$2(container);
  };
  var $_1si3u310fjkbnbd89 = {
    get: get$2,
    set: set$1,
    getOuter: getOuter
  };
  ...
  var shallowAs = function (original, tag) {
    ...
    var attributes = $_elmynfzwjkbnbd3c.clone(original);
    $_elmynfzwjkbnbd3c.setAll(nu, attributes);
    return nu;
  };
  var copy = function (original, tag) {
    var nu = shallowAs(original, tag);
    var cloneChildren = $_xmnonynjkbnbcov.children(deep$1(original));
    $_abel80z0jkbnbcsb.append(nu, cloneChildren);
    return nu;
  };
  var mutate = function (original, tag) {
    var nu = shallowAs(original, tag);
    $_4k9tcqymjkbnbcor.before(original, nu);
    var children = $_xmnonynjkbnbcov.children(original);
    $_abel80z0jkbnbcsb.append(nu, children);
    $_9sor8jyzjkbnbcs4.remove(original);
    return nu;
  };
  var $_73y71i10hjkbnbd8l = {
    shallow: shallow$1,
    shallowAs: shallowAs,
    deep: deep$1,
    copy: copy,
  ...
  var getHtml = function (element) {
    var clone = $_73y71i10hjkbnbd8l.shallow(element);
    return $_1si3u310fjkbnbd89.getOuter(clone);
  };
  ...
  var toggle$2 = function (component, toggleConfig, toggleState) {
    $_27wkbdzujkbnbd36.toggle(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var on = function (component, toggleConfig, toggleState) {
    $_27wkbdzujkbnbd36.add(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var off = function (component, toggleConfig, toggleState) {
    $_27wkbdzujkbnbd36.remove(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var isOn = function (component, toggleConfig) {
    return $_27wkbdzujkbnbd36.has(component.element(), toggleConfig.toggleClass());
  };
  ...
  var updatePressed = function (component, ariaInfo, status) {
    $_elmynfzwjkbnbd3c.set(component.element(), 'aria-pressed', status);
    if (ariaInfo.syncWithExpanded()) {
      updateExpanded(component, ariaInfo, status);
    }
  };
  var updateSelected = function (component, ariaInfo, status) {
    $_elmynfzwjkbnbd3c.set(component.element(), 'aria-selected', status);
  };
  var updateChecked = function (component, ariaInfo, status) {
    $_elmynfzwjkbnbd3c.set(component.element(), 'aria-checked', status);
  };
  var updateExpanded = function (component, ariaInfo, status) {
    $_elmynfzwjkbnbd3c.set(component.element(), 'aria-expanded', status);
  };
  ...
  var format = function (command, update) {
    return Receiving.config({
      channels: wrap$2($_dni3jc109jkbnbd6c.formatChanged(), {
  ...
  var orientation = function (onReceive) {
    return Receiving.config({ channels: wrap$2($_dni3jc109jkbnbd6c.orientationChanged(), { onReceive: onReceive }) });
  };
  ...
  var events$2 = function (optAction) {
    ...
    var pointerEvents = $_gfn29ky3jkbnbcjc.detect().deviceType.isTouch() ? [run(tap(), onClick)] : [
      run(click(), onClick),
  ...
  var focus$3 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_1jph6e101jkbnbd4i.focus(component.element());
      focusConfig.onFocus()(component);
    }
  };
  var blur$1 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_1jph6e101jkbnbd4i.blur(component.element());
    }
  };
  var isFocused = function (component) {
    return $_1jph6e101jkbnbd4i.hasFocus(component.element());
  };
  ...
  var $_l326g117jkbnbdib = { isSupported: isSupported };
  ...
  var internalSet = function (dom, property, value) {
    ...
    if ($_l326g117jkbnbdib.isSupported(dom))
  ...
  var get$3 = function (element, property) {
    ...
    var v = r === '' && !$_bm7r6hyhjkbnbcnh.inBody(element) ? getUnsafeProperty(dom, property) : r;
    return v === null ? undefined : v;
  };
  var getUnsafeProperty = function (dom, property) {
    return $_l326g117jkbnbdib.isSupported(dom) ? dom.style.getPropertyValue(property) : '';
  };
  ...
  var remove$5 = function (element, property) {
    ...
    if ($_elmynfzwjkbnbd3c.has(element, 'style') && trim($_elmynfzwjkbnbd3c.get(element, 'style')) === '') {
      $_elmynfzwjkbnbd3c.remove(element, 'style');
    }
  };
  var preserve = function (element, f) {
    var oldStyles = $_elmynfzwjkbnbd3c.get(element, 'style');
    var result = f(element);
    var restore = oldStyles === undefined ? $_elmynfzwjkbnbd3c.remove : $_elmynfzwjkbnbd3c.set;
  ...
  var copy$1 = function (source, target) {
    ...
    if ($_l326g117jkbnbdib.isSupported(sourceDom) && $_l326g117jkbnbdib.isSupported(targetDom)) {
  ...
  function Dimension (name, getOffset) {
    ...
    var get = function (element) {
      ...
      if (r <= 0 || r === null) {
        var css = $_5wkv2x116jkbnbdhj.get(element, name);
    ...
    var aggregate = function (element, properties) {
      return foldl(properties, function (acc, property) {
        var val = $_5wkv2x116jkbnbdhj.get(element, property);
  ...
  var api = Dimension('height', function (element) {
    var dom = element.dom();
    return $_bm7r6hyhjkbnbcnh.inBody(element) ? dom.getBoundingClientRect().height : dom.offsetHeight;
  });
  ...
  var setMax = function (element, value) {
    ...
    $_5wkv2x116jkbnbdhj.set(element, 'max-height', absMax + 'px');
  };
  var $_96oz3d115jkbnbdhf = {
    set: set$3,
    get: get$4,
    getOuter: getOuter$1,
    setMax: setMax
  ...
  var all$2 = function (predicate) {
    return descendants($_bm7r6hyhjkbnbcnh.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_xmnonynjkbnbcov.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_xmnonynjkbnbcov.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_xmnonynjkbnbcov.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each$1($_xmnonynjkbnbcov.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$3 = function (selector) {
    return $_dgipdcyyjkbnbcrr.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_b4ve8m11ajkbnbdix.ancestors(scope, function (e) {
      return $_dgipdcyyjkbnbcrr.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_b4ve8m11ajkbnbdix.siblings(scope, function (e) {
      return $_dgipdcyyjkbnbcrr.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_b4ve8m11ajkbnbdix.children(scope, function (e) {
      return $_dgipdcyyjkbnbcrr.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_dgipdcyyjkbnbcrr.all(selector, scope);
  };
  var $_bhdqux119jkbnbdis = {
    all: all$3,
  ...
  var first$2 = function (selector) {
    return $_dgipdcyyjkbnbcrr.one(selector);
  };
  var ancestor$2 = function (scope, selector, isRoot) {
    return $_c6nan6103jkbnbd52.ancestor(scope, function (e) {
      return $_dgipdcyyjkbnbcrr.is(e, selector);
    }, isRoot);
  };
  var sibling$2 = function (scope, selector) {
    return $_c6nan6103jkbnbd52.sibling(scope, function (e) {
      return $_dgipdcyyjkbnbcrr.is(e, selector);
    });
  };
  var child$3 = function (scope, selector) {
    return $_c6nan6103jkbnbd52.child(scope, function (e) {
      return $_dgipdcyyjkbnbcrr.is(e, selector);
    });
  };
  var descendant$2 = function (scope, selector) {
    return $_dgipdcyyjkbnbcrr.one(selector, scope);
  };
  var closest$2 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_dgipdcyyjkbnbcrr.is, ancestor$2, scope, selector, isRoot);
  };
  var $_23b1y811bjkbnbdj5 = {
    first: first$2,
    ancestor: ancestor$2,
    sibling: sibling$2,
    child: child$3,
  ...
  var dehighlightAll = function (component, hConfig, hState) {
    var highlighted = $_bhdqux119jkbnbdis.descendants(component.element(), '.' + hConfig.highlightClass());
    each$1(highlighted, function (h) {
      $_27wkbdzujkbnbd36.remove(h, hConfig.highlightClass());
  ...
  var dehighlight = function (component, hConfig, hState, target) {
    ...
    $_27wkbdzujkbnbd36.remove(target.element(), hConfig.highlightClass());
    if (wasHighlighted) {
      hConfig.onDehighlight()(component, target);
    }
  };
  var highlight = function (component, hConfig, hState, target) {
    ...
    $_27wkbdzujkbnbd36.add(target.element(), hConfig.highlightClass());
    if (!wasHighlighted) {
  ...
  var highlightBy = function (component, hConfig, hState, predicate) {
    var items = $_bhdqux119jkbnbdis.descendants(component.element(), '.' + hConfig.itemClass());
  ...
  var isHighlighted = function (component, hConfig, hState, queryTarget) {
    return $_27wkbdzujkbnbd36.has(queryTarget.element(), hConfig.highlightClass());
  };
  var getHighlighted = function (component, hConfig, hState) {
    return $_23b1y811bjkbnbdj5.descendant(component.element(), '.' + hConfig.highlightClass()).bind(function (e) {
  ...
  var getFirst = function (component, hConfig, hState) {
    return $_23b1y811bjkbnbdj5.descendant(component.element(), '.' + hConfig.itemClass()).bind(function (e) {
      return component.getSystem().getByDom(e).toOption();
    });
  };
  ...
  var getDelta = function (component, hConfig, hState, delta) {
    ...
    var current = findIndex(items, function (item) {
      return $_27wkbdzujkbnbd36.has(item, hConfig.highlightClass());
    });
  ...
  var dom = function () {
    var get = function (component) {
      return $_1jph6e101jkbnbd4i.search(component.element());
    };
  ...
  var create$2 = function (cyclicField) {
    ...
    var isVisible = function (tabbingConfig, element) {
      var target = tabbingConfig.visibilitySelector().bind(function (sel) {
        return $_23b1y811bjkbnbdj5.closest(element, sel);
      }).getOr(element);
      return $_96oz3d115jkbnbdhf.get(target) > 0;
    };
    var findInitial = function (component, tabbingConfig) {
      var tabstops = $_bhdqux119jkbnbdis.descendants(component.element(), tabbingConfig.selector());
    ...
    var findCurrent = function (component, tabbingConfig) {
      return tabbingConfig.focusManager().get(component).bind(function (elem) {
        return $_23b1y811bjkbnbdj5.closest(elem, tabbingConfig.selector());
      });
    };
    ...
    var go = function (component, simulatedEvent, tabbingConfig, cycle) {
      ...
      return findCurrent(component, tabbingConfig).bind(function (tabstop) {
        var optStopIndex = findIndex(tabstops, curry($_3nd6p8ytjkbnbcq4.eq, tabstop));
  ...
  var inside = function (target) {
    return $_391003ykjkbnbcok.name(target) === 'input' && $_elmynfzwjkbnbd3c.get(target, 'type') !== 'radio' || $_391003ykjkbnbcok.name(target) === 'textarea';
  };
  ...
  var getDirection = function (element) {
    return $_5wkv2x116jkbnbdhj.get(element, 'direction') === 'rtl' ? 'rtl' : 'ltr';
  };
  var $_1q1l0211tjkbnbdon = {
  ...
  var west = function (moveLeft, moveRight) {
    var movement = $_1q1l0211tjkbnbdon.onDirection(moveLeft, moveRight);
    return useH(movement);
  };
  var east = function (moveLeft, moveRight) {
    var movement = $_1q1l0211tjkbnbdon.onDirection(moveRight, moveLeft);
    return useH(movement);
  };
  ...
  var visibilityToggler = function (element, property, hiddenValue, visibleValue) {
    var initial = $_5wkv2x116jkbnbdhj.get(element, property);
    if (initial === undefined)
      initial = '';
    var value = initial === hiddenValue ? visibleValue : hiddenValue;
    var off = curry($_5wkv2x116jkbnbdhj.set, element, property, initial);
    var on = curry($_5wkv2x116jkbnbdhj.set, element, property, value);
  ...
  var locateVisible = function (container, current, selector) {
    var filter$$1 = $_pdh1911vjkbnbdpd.isVisible;
    return locateIn(container, current, selector, filter$$1);
  };
  var locateIn = function (container, current, selector, filter$$1) {
    var predicate = curry($_3nd6p8ytjkbnbcq4.eq, current);
    var candidates = $_bhdqux119jkbnbdis.descendants(container, selector);
    var visible = filter(candidates, $_pdh1911vjkbnbdpd.isVisible);
    return locate(visible, predicate);
  };
  var findIndex$2 = function (elements, target) {
    return findIndex(elements, function (elem) {
      return $_3nd6p8ytjkbnbcq4.eq(target, elem);
    });
  };
  ...
  var focusIn = function (component, gridConfig, gridState) {
    $_23b1y811bjkbnbdj5.descendant(component.element(), gridConfig.selector()).each(function (first) {
      gridConfig.focusManager().set(component, first);
    });
  };
  var findCurrent = function (component, gridConfig) {
    return gridConfig.focusManager().get(component).bind(function (elem) {
      return $_23b1y811bjkbnbdj5.closest(elem, gridConfig.selector());
    });
  };
  ...
  var findCurrent$1 = function (component, flowConfig) {
    return flowConfig.focusManager().get(component).bind(function (elem) {
      return $_23b1y811bjkbnbdj5.closest(elem, flowConfig.selector());
    });
  };
  ...
  var focusIn$1 = function (component, flowConfig) {
    flowConfig.getInitial()(component).or($_23b1y811bjkbnbdj5.descendant(component.element(), flowConfig.selector())).each(function (first) {
  ...
  var focusIn$2 = function (component, matrixConfig) {
    var focused = matrixConfig.previousSelector()(component).orThunk(function () {
      ...
      return $_23b1y811bjkbnbdj5.descendant(component.element(), selectors.cell());
    });
  ...
  var execute$4 = function (component, simulatedEvent, matrixConfig) {
    return $_1jph6e101jkbnbd4i.search(component.element()).bind(function (focused) {
      return matrixConfig.execute()(component, simulatedEvent, focused);
    });
  };
  var toMatrix = function (rows, matrixConfig) {
    return map$1(rows, function (row) {
      return $_bhdqux119jkbnbdis.descendants(row, matrixConfig.selectors().cell());
    });
  };
  var doMove$2 = function (ifCycle, ifMove) {
    return function (element, focused, matrixConfig) {
      var move$$1 = matrixConfig.cycles() ? ifCycle : ifMove;
      return $_23b1y811bjkbnbdj5.closest(focused, matrixConfig.selectors().row()).bind(function (inRow) {
        var cellsInRow = $_bhdqux119jkbnbdis.descendants(inRow, matrixConfig.selectors().cell());
        return findIndex$2(cellsInRow, focused).bind(function (colIndex) {
          var allRows = $_bhdqux119jkbnbdis.descendants(element, matrixConfig.selectors().row());
  ...
  var focusIn$3 = function (component, menuConfig) {
    $_23b1y811bjkbnbdj5.descendant(component.element(), menuConfig.selector()).each(function (first) {
  ...
  var subPlaceholder = function (owner, detail, compSpec, placeholders) {
    ...
    return readOptFrom$1(placeholders, compSpec.name).fold(function () {
      throw new Error('Unknown placeholder component: ' + compSpec.name + '\nKnown: [' + keys(placeholders) + ']\nNamespace: ' + owner.getOr('none') + '\nSpec: ' + $_g9lk3czhjkbnbcxq.stringify(compSpec, null, 2));
    }, function (newSpec) {
  ...
  var substitutePlaces = function (owner, detail, components, placeholders) {
    ...
    each(ps, function (p) {
      if (p.used() === false && p.required()) {
        throw new Error('Placeholder: ' + p.name() + ' was not found in components list\nNamespace: ' + owner.getOr('none') + '\nComponents: ' + $_g9lk3czhjkbnbcxq.stringify(detail.components(), null, 2));
      }
    });
    return outcome;
  };
  ...
  var write = function (label, elem) {
    ...
    $_elmynfzwjkbnbd3c.set(elem, idAttr$1, id);
    return id;
  };
  var writeOnly = function (elem, uid) {
    $_elmynfzwjkbnbd3c.set(elem, idAttr$1, uid);
  };
  var read$2 = function (elem) {
    var id = $_391003ykjkbnbcok.isElement(elem) ? $_elmynfzwjkbnbd3c.get(elem, idAttr$1) : null;
  ...
  var fromHtml$2 = function (html) {
    ...
    var children = $_xmnonynjkbnbcov.children(elem);
    var attrs = getAttrs(elem);
    var classes = getClasses(elem);
    var contents = children.length === 0 ? {} : { innerHtml: $_1si3u310fjkbnbd89.get(elem) };
    return deepMerge({
      tag: $_391003ykjkbnbcok.name(elem),
      classes: classes,
      attributes: attrs
    }, contents);
  };
  ...
  var dom$1 = function (rawHtml) {
    var html = supplant(rawHtml, { prefix: $_b6jmid10tjkbnbddg.prefix() });
  ...
  var getToggleBehaviours = function (command) {
    return derive$2([
      Toggling.config({
        toggleClass: $_b6jmid10tjkbnbddg.resolve('toolbar-button-selected'),
        toggleOnExecute: false,
        aria: { mode: 'pressed' }
      }),
      $_7q8zmc10sjkbnbdd8.format(command, function (button, status) {
  ...
  var isTouch = $_gfn29ky3jkbnbcjc.detect().deviceType.isTouch();
  ...
  var platform = $_gfn29ky3jkbnbcjc.detect();
  ...
  var isTouch$2 = $_gfn29ky3jkbnbcjc.detect().deviceType.isTouch();
  var SliderSchema = [
    strict$1('min'),
    strict$1('max'),
  ...
  var setMax$1 = function (element, value) {
    ...
    $_5wkv2x116jkbnbdhj.set(element, 'max-width', absMax + 'px');
  };
  var $_9a05e6130jkbnbeas = {
    set: set$4,
    get: get$6,
    getOuter: getOuter$2,
    setMax: setMax$1
  ...
  var isTouch$3 = $_gfn29ky3jkbnbcjc.detect().deviceType.isTouch();
  var sketch$1 = function (detail, components$$1, spec, externals) {
    ...
    var refresh = function (component) {
      ...
      var thumbRadius = $_9a05e6130jkbnbeas.get(thumb.element()) / 2;
      $_5wkv2x116jkbnbdhj.set(thumb.element(), 'left', pos - thumbRadius + 'px');
    };
    var changeValue = function (component, newValue) {
      var oldValue = detail.value().get();
      var thumb = getThumb(component);
      if (oldValue !== newValue || $_5wkv2x116jkbnbdhj.getRaw(thumb.element(), 'left').isNone()) {
  ...
  var button = function (realm, clazz, makeItems) {
    return $_cwg4bm10ujkbnbddm.forToolbar(clazz, function () {
      var items = makeItems();
  ...
  var makeSlider = function (spec$$1) {
    ...
    var onInit = function (slider, thumb, value) {
      ...
      $_5wkv2x116jkbnbdhj.set(thumb.element(), 'background-color', color);
    };
    ...
    return Slider.sketch({
      ...
      components: [
        ...
        Slider.parts().spectrum({
          ...
          behaviours: derive$2([Toggling.config({ toggleClass: $_b6jmid10tjkbnbddg.resolve('thumb-active') })])
        }),
      ...
      sliderBehaviours: derive$2([$_7q8zmc10sjkbnbdd8.orientation(Slider.refresh)])
    });
  };
  ...
  var sketch$3 = function (rawSpec) {
    ...
    return Slider.sketch({
      dom: {
        tag: 'div',
        classes: [
          $_b6jmid10tjkbnbddg.resolve('slider-' + spec$$1.category + '-size-container'),
          $_b6jmid10tjkbnbddg.resolve('slider'),
          $_b6jmid10tjkbnbddg.resolve('slider-size-container')
        ]
      },
      onChange: onChange,
      onDragStart: function (slider, thumb) {
  ...
  var $_cfj92b133jkbnbeb2 = { sketch: sketch$3 };
  ...
  var getRawOrComputed = function (isRoot, rawStart) {
    var optStart = $_391003ykjkbnbcok.isElement(rawStart) ? Option.some(rawStart) : $_xmnonynjkbnbcov.parent(rawStart);
    return optStart.map(function (start) {
      var inline = $_c6nan6103jkbnbd52.closest(start, function (elem) {
        return $_5wkv2x116jkbnbdhj.getRaw(elem, 'font-size').isSome();
      }, isRoot).bind(function (elem) {
        return $_5wkv2x116jkbnbdhj.getRaw(elem, 'font-size');
      });
      return inline.getOrThunk(function () {
        return $_5wkv2x116jkbnbdhj.get(start, 'font-size');
      });
    }).getOr('');
  };
  var getSize = function (editor) {
    ...
    var isRoot = function (e) {
      return $_3nd6p8ytjkbnbcq4.eq(root, e);
    };
  ...
  var $_fsqcam134jkbnbebm = {
    candidates: constant(candidates),
    get: get$7,
    apply: apply$1
  };

  var sizes = $_fsqcam134jkbnbebm.candidates();
  var makeSlider$1 = function (spec$$1) {
    return $_cfj92b133jkbnbeb2.sketch({
  ...
  var sketch$4 = function (realm, editor) {
    var spec$$1 = {
      onChange: function (value) {
        $_fsqcam134jkbnbebm.apply(editor, value);
      },
      getInitialValue: function () {
        return $_fsqcam134jkbnbebm.get(editor);
      }
    };
  ...
  function Blob (parts, properties) {
    var f = $_cf6yy1yvjkbnbcrf.getOrDie('Blob');
    return new f(parts, properties);
  }

  function FileReader () {
    var f = $_cf6yy1yvjkbnbcrf.getOrDie('FileReader');
    return new f();
  }

  function Uint8Array (arr) {
    var f = $_cf6yy1yvjkbnbcrf.getOrDie('Uint8Array');
    return new f(arr);
  }

  var requestAnimationFrame = function (callback) {
    var f = $_cf6yy1yvjkbnbcrf.getOrDie('requestAnimationFrame');
    f(callback);
  };
  var atob = function (base64) {
    var f = $_cf6yy1yvjkbnbcrf.getOrDie('atob');
    return f(base64);
  };
  var $_5qif8o13fjkbnbefm = {
    atob: atob,
  ...
  function dataUriToBlobSync(uri) {
    ...
    var base64 = data[1];
    var sliceSize = 1024;
    var byteCharacters = $_5qif8o13fjkbnbefm.atob(base64);
  ...
  function blobToCanvas(blob) {
    return blobToImage(blob).then(function (image) {
      ...
      var context, canvas;
      canvas = $_39ujo4139jkbnbef3.create($_5pxrat13ajkbnbef6.getWidth(image), $_5pxrat13ajkbnbef6.getHeight(image));
      context = $_39ujo4139jkbnbef3.get2dContext(canvas);
  ...
  var blobToImage$1 = function (image) {
    return $_4g00mz138jkbnbee7.blobToImage(image);
  };
  var imageToBlob$1 = function (blob) {
    return $_4g00mz138jkbnbee7.imageToBlob(blob);
  };
  var blobToDataUri$1 = function (blob) {
    return $_4g00mz138jkbnbee7.blobToDataUri(blob);
  };
  var blobToBase64$1 = function (blob) {
    return $_4g00mz138jkbnbee7.blobToBase64(blob);
  };
  var dataUriToBlobSync$1 = function (uri) {
    return $_4g00mz138jkbnbee7.dataUriToBlobSync(uri);
  };
  var uriToBlob$1 = function (uri) {
    return Option.from($_4g00mz138jkbnbee7.uriToBlob(uri));
  };
  var $_71ykai137jkbnbedz = {
  ...
  var addImage = function (editor, blob) {
    $_71ykai137jkbnbedz.blobToBase64(blob).then(function (base64) {
      editor.undoManager.transact(function () {
  ...
  var fromLink = function (link) {
    var text = $_p9gxa13ijkbnbegs.get(link);
    var url = $_elmynfzwjkbnbd3c.get(link, 'href');
    var title = $_elmynfzwjkbnbd3c.get(link, 'title');
    var target = $_elmynfzwjkbnbd3c.get(link, 'target');
    return {
  ...
  var wasSimple = function (link) {
    var prevHref = $_elmynfzwjkbnbd3c.get(link, 'href');
    var prevText = $_p9gxa13ijkbnbegs.get(link);
  ...
  var applyInfo = function (editor, info) {
    info.url.filter(isNotEmpty).fold(function () {
      ...
      activeLink.fold(function () {
        ...
        $_elmynfzwjkbnbd3c.setAll(link, attrs);
        text.each(function (newText) {
          $_p9gxa13ijkbnbegs.set(link, newText);
        });
      });
    });
  };
  var query = function (editor) {
    ...
    return $_23b1y811bjkbnbdj5.closest(start, 'a');
  };
  var $_daey413hjkbnbeg3 = {
    getInfo: getInfo,
    applyInfo: applyInfo,
    query: query
  };

  var platform$1 = $_gfn29ky3jkbnbcjc.detect();
  ...
  var $_8f8uhz13jjkbnbegv = { forAndroid: forAndroid };
  ...
  var focusBehaviours = function (detail) {
    return derive$2([Focusing.config({
        onFocus: detail.selectOnFocus() === false ? noop : function (component) {
          ...
          var value = $_bf9kuq13tjkbnbele.get(input);
    ...
    return deepMerge(derive$2([Representing.config({
        store: {
          ...
          getValue: function (input) {
            return $_bf9kuq13tjkbnbele.get(input.element());
          },
          setValue: function (input, data) {
            var current = $_bf9kuq13tjkbnbele.get(input.element());
            if (current !== data) {
              $_bf9kuq13tjkbnbele.set(input.element(), data);
            }
          }
        },
    ...
    return {
      ...
      spec: Container.sketch({
        ...
        containerBehaviours: derive$2([
          Toggling.config({ toggleClass: $_b6jmid10tjkbnbddg.resolve('input-container-empty') }),
          Composing.config({
            find: function (comp) {
  ...
  var hasNative = function (component) {
    return contains(nativeDisabled, $_391003ykjkbnbcok.name(component.element()));
  };
  var nativeIsDisabled = function (component) {
    return $_elmynfzwjkbnbd3c.has(component.element(), 'disabled');
  };
  var nativeDisable = function (component) {
    $_elmynfzwjkbnbd3c.set(component.element(), 'disabled', 'disabled');
  };
  var nativeEnable = function (component) {
    $_elmynfzwjkbnbd3c.remove(component.element(), 'disabled');
  };
  var ariaIsDisabled = function (component) {
    return $_elmynfzwjkbnbd3c.get(component.element(), 'aria-disabled') === 'true';
  };
  var ariaDisable = function (component) {
    $_elmynfzwjkbnbd3c.set(component.element(), 'aria-disabled', 'true');
  };
  var ariaEnable = function (component) {
    $_elmynfzwjkbnbd3c.set(component.element(), 'aria-disabled', 'false');
  };
  var disable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_27wkbdzujkbnbd36.add(component.element(), disableClass);
    });
  ...
  var enable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_27wkbdzujkbnbd36.remove(component.element(), disableClass);
    });
  ...
  var sketch$7 = function (rawSpec) {
    ...
    var navigationButton = function (direction, directionName, enabled) {
      return Button.sketch({
        ...
        buttonBehaviours: derive$2([Disabling.config({
            disableClass: $_b6jmid10tjkbnbddg.resolve('toolbar-navigation-disabled'),
            disabled: !enabled
          })])
      });
    };
    var reposition = function (dialog, message) {
      $_23b1y811bjkbnbdj5.descendant(dialog.element(), '.' + $_b6jmid10tjkbnbddg.resolve('serialised-dialog-chain')).each(function (parent) {
        $_5wkv2x116jkbnbdhj.set(parent, 'left', -spec$$1.state.currentScreen.get() * message.width + 'px');
      });
    };
    var navigate = function (dialog, direction) {
      var screens = $_bhdqux119jkbnbdis.descendants(dialog.element(), '.' + $_b6jmid10tjkbnbddg.resolve('serialised-dialog-screen'));
      $_23b1y811bjkbnbdj5.descendant(dialog.element(), '.' + $_b6jmid10tjkbnbddg.resolve('serialised-dialog-chain')).each(function (parent) {
        if (spec$$1.state.currentScreen.get() + direction >= 0 && spec$$1.state.currentScreen.get() + direction < screens.length) {
          $_5wkv2x116jkbnbdhj.getRaw(parent, 'left').each(function (left) {
            var currentLeft = parseInt(left, 10);
            var w = $_9a05e6130jkbnbeas.get(screens[0]);
            $_5wkv2x116jkbnbdhj.set(parent, 'left', currentLeft - direction * w + 'px');
          });
    ...
    var focusInput = function (dialog) {
      var inputs = $_bhdqux119jkbnbdis.descendants(dialog.element(), 'input');
    ...
    var memForm = record(Form.sketch(function (parts) {
      return {
        ...
        formBehaviours: derive$2([
          $_7q8zmc10sjkbnbdd8.orientation(function (dialog, message) {
    ...
    var memDots = record({
      ...
      behaviours: derive$2([Highlighting.config({
          highlightClass: $_b6jmid10tjkbnbddg.resolve('dot-active'),
          itemClass: $_b6jmid10tjkbnbddg.resolve('dot-item')
        })]),
      ...
      behaviours: derive$2([
        ...
        config(wrapperAdhocEvents, [
          run(touchstart(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.set($_9tacg144jkbnbepy.init(event.touches[0].clientX));
          }),
          run(touchmove(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.on(function (state) {
              simulatedEvent.event().prevent();
              spec$$1.state.dialogSwipeState.set($_9tacg144jkbnbepy.move(state, event.raw().touches[0].clientX));
            });
          }),
          run(touchend(), function (wrapper) {
            spec$$1.state.dialogSwipeState.on(function (state) {
              var dialog = memForm.get(wrapper);
              var direction = -1 * $_9tacg144jkbnbepy.complete(state);
              navigate(dialog, direction);
            });
          })
        ])
  ...
  var getGroups = cached(function (realm, editor) {
    return [{
        ...
        items: [sketch$7({
            ...
            getInitialValue: function () {
              return Option.some($_daey413hjkbnbeg3.getInfo(editor));
            },
            onExecute: function (dialog) {
              var info = Representing.getValue(dialog);
              $_daey413hjkbnbeg3.applyInfo(editor, info);
  ...
  var sketch$8 = function (realm, editor) {
    return $_cwg4bm10ujkbnbddm.forToolbarStateAction(editor, 'link', 'link', function () {
      var groups = getGroups(realm, editor);
      realm.setContextToolbar(groups);
      $_8f8uhz13jjkbnbegv.forAndroid(editor, function () {
        realm.focusToolbar();
      });
      $_daey413hjkbnbeg3.query(editor).each(function (link) {
  ...
  var isRecursive = function (component, originator, target) {
    return $_3nd6p8ytjkbnbcq4.eq(originator, component.element()) && !$_3nd6p8ytjkbnbcq4.eq(originator, target);
  };
  ...
  var generateFrom = function (spec, all) {
    ...
    var validated = asStruct('component.behaviours', objOf(schema), spec.behaviours).fold(function (errInfo) {
      throw new Error(formatError(errInfo) + '\nComplete spec:\n' + $_g9lk3czhjkbnbcxq.stringify(spec, null, 2));
    }, function (v) {
      return v;
    });
    return {
  ...
  var onlyOne = function (chain, aspect) {
    if (chain.length > 1) {
      return Result.error('Multiple behaviours have tried to change DOM "' + aspect + '". The guilty behaviours are: ' + $_g9lk3czhjkbnbcxq.stringify(map$1(chain, function (b) {
        return b.name();
  ...
  var duplicate = function (aspect, k, obj, behaviours) {
    return Result.error('Mulitple behaviours have tried to change the _' + k + '_ "' + aspect + '"' + '. The guilty behaviours are: ' + $_g9lk3czhjkbnbcxq.stringify(bind(behaviours, function (b) {
  ...
  var sortKeys = function (label, keyName, array, order) {
    ...
    try {
      var sorted = sliced.sort(function (a, b) {
        ...
        if (aIndex === -1) {
          throw new Error('The ordering for ' + label + ' does not have an entry for ' + aKey + '.\nOrder specified: ' + $_g9lk3czhjkbnbcxq.stringify(order, null, 2));
        }
        if (bIndex === -1) {
  ...
  var missingOrderError = function (eventName, tuples) {
    return Result.error(['The event (' + eventName + ') has more than one behaviour that listens to it.\nWhen this occurs, you must ' + 'specify an event ordering for the behaviours in your spec (e.g. [ "listing", "toggling" ]).\nThe behaviours that ' + 'can trigger it are: ' + $_g9lk3czhjkbnbcxq.stringify(map$1(tuples, function (c) {
        return c.name();
      }), null, 2)]);
  };
  ...
  var add$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_27wkbdzujkbnbd36.add(element, x);
    });
  };
  var remove$6 = function (element, classes) {
    each$1(classes, function (x) {
      $_27wkbdzujkbnbd36.remove(element, x);
    });
  };
  var toggle$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_27wkbdzujkbnbd36.toggle(element, x);
    });
  };
  var hasAll = function (element, classes) {
    return forall(classes, function (clazz) {
      return $_27wkbdzujkbnbd36.has(element, clazz);
    });
  };
  ...
  var get$10 = function (element) {
    return $_4lgitfzxjkbnbd3v.supports(element) ? getNative(element) : $_4lgitfzxjkbnbd3v.get(element);
  };
  var $_c411m314mjkbnbf1s = {
    add: add$3,
    remove: remove$6,
    toggle: toggle$3,
    hasAll: hasAll,
  ...
  var renderToDom = function (definition) {
    ...
    $_elmynfzwjkbnbd3c.setAll(subject, definition.attributes().getOr({}));
    $_c411m314mjkbnbf1s.add(subject, definition.classes().getOr([]));
    $_5wkv2x116jkbnbdhj.setAll(subject, definition.styles().getOr({}));
    $_1si3u310fjkbnbd89.set(subject, definition.innerHtml().getOr(''));
    var children = getChildren(definition);
    $_abel80z0jkbnbcsb.append(subject, children);
    definition.value().each(function (value) {
      $_bf9kuq13tjkbnbele.set(subject, value);
    });
    return subject;
  };
  ...
  var build = function (spec) {
    ...
    var syncComponents = function () {
      var children = $_xmnonynjkbnbcov.children(item);
    ...
    var config = function (behaviour) {
      ...
      var f = isFunction(b[behaviour.name()]) ? b[behaviour.name()] : function () {
        throw new Error('Could not find ' + behaviour.name() + ' in ' + $_g9lk3czhjkbnbcxq.stringify(spec, null, 2));
      };
      return f();
    };
  ...
  var onHover = function (item) {
    if ($_1jph6e101jkbnbd4i.search(item.element()).isNone() || Focusing.isFocused(item)) {
  ...
  var preserve$2 = function (f, container) {
    var ownerDoc = $_xmnonynjkbnbcov.owner(container);
    var refocus = $_1jph6e101jkbnbd4i.active(ownerDoc).bind(function (focused) {
      var hasFocus = function (elem) {
        return $_3nd6p8ytjkbnbcq4.eq(focused, elem);
      };
      return hasFocus(container) ? Option.some(container) : $_c6nan6103jkbnbd52.descendant(container, hasFocus);
    });
    var result = f(container);
    refocus.each(function (oldFocus) {
      $_1jph6e101jkbnbd4i.active(ownerDoc).filter(function (newFocus) {
        return $_3nd6p8ytjkbnbcq4.eq(newFocus, oldFocus);
      }).fold(function () {
        $_1jph6e101jkbnbd4i.focus(oldFocus);
      }, noop);
    });
    return result;
  };
  ...
  var append$2 = function (component, replaceConfig, replaceState, appendee) {
    insert(component, replaceConfig, $_4k9tcqymjkbnbcor.append, appendee);
  };
  var prepend$2 = function (component, replaceConfig, replaceState, prependee) {
    insert(component, replaceConfig, $_4k9tcqymjkbnbcor.prepend, prependee);
  };
  var remove$7 = function (component, replaceConfig, replaceState, removee) {
    var children = contents(component, replaceConfig);
    var foundChild = find$2(children, function (child) {
      return $_3nd6p8ytjkbnbcq4.eq(removee.element(), child.element());
    });
  ...
  var make$3 = function (detail, rawUiSpec) {
    ...
    var updateMenuPath = function (container, state, path) {
      return Option.from(path[0]).bind(state.lookupMenu).map(function (activeMenu) {
        ...
        each$1(rest, function (r) {
          $_27wkbdzujkbnbd36.add(r.element(), detail.markers().backgroundMenu());
        });
        if (!$_bm7r6hyhjkbnbcnh.inBody(activeMenu.element())) {
          Replacing.append(container, premade$1(activeMenu));
        }
        $_c411m314mjkbnbf1s.remove(activeMenu.element(), [detail.markers().backgroundMenu()]);
        setActiveMenu(container, activeMenu);
        var others = getMenus(state, state.otherMenus(path));
        each$1(others, function (o) {
          $_c411m314mjkbnbf1s.remove(o.element(), [detail.markers().backgroundMenu()]);
          if (!detail.stayInDom()) {
    ...
    var keyOnItem = function (f) {
      return function (container, simulatedEvent) {
        return $_23b1y811bjkbnbdj5.closest(simulatedEvent.getSource(), '.' + detail.markers().item()).bind(function (target) {
  ...
  var disableTransition = function (comp, transConfig, transState) {
    getTransition(comp, transConfig, transState).each(function (routeTransition) {
      ...
      $_27wkbdzujkbnbd36.remove(comp.element(), t.transitionClass());
      $_elmynfzwjkbnbd3c.remove(comp.element(), transConfig.destinationAttr());
    });
  };
  var getNewRoute = function (comp, transConfig, transState, destination) {
    return {
      start: constant($_elmynfzwjkbnbd3c.get(comp.element(), transConfig.stateAttr())),
      destination: constant(destination)
    };
  };
  var getCurrentRoute = function (comp, transConfig, transState) {
    var el = comp.element();
    return $_elmynfzwjkbnbd3c.has(el, transConfig.destinationAttr()) ? Option.some({
      start: constant($_elmynfzwjkbnbd3c.get(comp.element(), transConfig.stateAttr())),
      destination: constant($_elmynfzwjkbnbd3c.get(comp.element(), transConfig.destinationAttr()))
    }) : Option.none();
  };
  var jumpTo = function (comp, transConfig, transState, destination) {
    disableTransition(comp, transConfig, transState);
    if ($_elmynfzwjkbnbd3c.has(comp.element(), transConfig.stateAttr()) && $_elmynfzwjkbnbd3c.get(comp.element(), transConfig.stateAttr()) !== destination) {
      transConfig.onFinish()(comp, destination);
    }
    $_elmynfzwjkbnbd3c.set(comp.element(), transConfig.stateAttr(), destination);
  };
  var fasttrack = function (comp, transConfig, transState, destination) {
    if ($_elmynfzwjkbnbd3c.has(comp.element(), transConfig.destinationAttr())) {
      $_elmynfzwjkbnbd3c.set(comp.element(), transConfig.stateAttr(), $_elmynfzwjkbnbd3c.get(comp.element(), transConfig.destinationAttr()));
      $_elmynfzwjkbnbd3c.remove(comp.element(), transConfig.destinationAttr());
    }
  };
  var progressTo = function (comp, transConfig, transState, destination) {
    ...
    getTransitionOf(comp, transConfig, transState, route).fold(function () {
      ...
      disableTransition(comp, transConfig, transState);
      var t = routeTransition.transition();
      $_27wkbdzujkbnbd36.add(comp.element(), t.transitionClass());
      $_elmynfzwjkbnbd3c.set(comp.element(), transConfig.destinationAttr(), destination);
    });
  };
  var getState = function (comp, transConfig, transState) {
    var e = comp.element();
    return $_elmynfzwjkbnbd3c.has(e, transConfig.stateAttr()) ? Option.some($_elmynfzwjkbnbd3c.get(e, transConfig.stateAttr())) : Option.none();
  };
  ...
  var scrollable = $_b6jmid10tjkbnbddg.resolve('scrollable');
  var register = function (element) {
    $_27wkbdzujkbnbd36.add(element, scrollable);
  };
  var deregister = function (element) {
    $_27wkbdzujkbnbd36.remove(element, scrollable);
  };
  var $_25ej2t159jkbnbfc1 = {
    register: register,
  ...
  var makeItem = function (value, text$$1, selected, preview, isMenu) {
    return {
      ...
      dom: {
        tag: 'div',
        classes: isMenu ? [$_b6jmid10tjkbnbddg.resolve('styles-item-is-menu')] : []
      },
      toggling: {
        toggleOnExecute: false,
        toggleClass: $_b6jmid10tjkbnbddg.resolve('format-matches'),
        selected: selected
      },
      itemBehaviours: derive$2(isMenu ? [] : [$_7q8zmc10sjkbnbdd8.format(value, function (comp, status) {
          var toggle = status ? Toggling.on : Toggling.off;
          toggle(comp);
        })]),
      components: [{
    ...
    return {
      ...
      components: [
        Button.sketch({
          dom: {
            tag: 'div',
            classes: [$_b6jmid10tjkbnbddg.resolve('styles-collapser')]
          },
          components: collapsable ? [
            {
              dom: {
                tag: 'span',
                classes: [$_b6jmid10tjkbnbddg.resolve('styles-collapse-icon')]
              }
            },
            text(value)
          ] : [text(value)],
        ...
        }),
        {
          dom: {
            tag: 'div',
            classes: [$_b6jmid10tjkbnbddg.resolve('styles-menu-items-container')]
          },
          components: [Menu.parts().items({})],
          behaviours: derive$2([config('adhoc-scrollable-menu', [
              runOnAttached(function (component, simulatedEvent) {
                $_5wkv2x116jkbnbdhj.set(component.element(), 'overflow-y', 'auto');
                $_5wkv2x116jkbnbdhj.set(component.element(), '-webkit-overflow-scrolling', 'touch');
                $_25ej2t159jkbnbfc1.register(component.element());
              }),
              runOnDetached(function (component) {
                $_5wkv2x116jkbnbdhj.remove(component.element(), 'overflow-y');
                $_5wkv2x116jkbnbdhj.remove(component.element(), '-webkit-overflow-scrolling');
                $_25ej2t159jkbnbfc1.deregister(component.element());
              })
            ])])
        }
      ],
  ...
  var sketch$9 = function (settings) {
    ...
    var memMenu = record(tieredMenu.sketch({
      dom: {
        tag: 'div',
        classes: [$_b6jmid10tjkbnbddg.resolve('styles-menu')]
      },
      components: [],
      fakeFocus: true,
      stayInDom: true,
      ...
      onOpenMenu: function (container, menu) {
        var w = $_9a05e6130jkbnbeas.get(container.element());
        $_9a05e6130jkbnbeas.set(menu.element(), w);
        Transitioning.jumpTo(menu, 'current');
      },
      onOpenSubmenu: function (container, item, submenu) {
        var w = $_9a05e6130jkbnbeas.get(container.element());
        var menu = $_23b1y811bjkbnbdj5.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
        var menuComp = container.getSystem().getByDom(menu).getOrDie();
        $_9a05e6130jkbnbeas.set(submenu.element(), w);
        Transitioning.progressTo(menuComp, 'before');
        Transitioning.jumpTo(submenu, 'after');
        Transitioning.progressTo(submenu, 'current');
      },
      onCollapseMenu: function (container, item, menu) {
        var submenu = $_23b1y811bjkbnbdj5.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
      ...
      data: dataset.tmenu,
      markers: {
        backgroundMenu: $_b6jmid10tjkbnbddg.resolve('styles-background-menu'),
        menu: $_b6jmid10tjkbnbddg.resolve('styles-menu'),
        selectedMenu: $_b6jmid10tjkbnbddg.resolve('styles-selected-menu'),
        item: $_b6jmid10tjkbnbddg.resolve('styles-item'),
        selectedItem: $_b6jmid10tjkbnbddg.resolve('styles-selected-item')
      }
    }));
    return memMenu.asSpec();
  };
  var $_b5x6ze147jkbnbeqw = { sketch: sketch$9 };
  ...
  var $_ayfs9e15ajkbnbfcc = { expand: expand };
  ...
  var prune = function (editor, formats) {
    ...
    return $_ayfs9e15ajkbnbfcc.expand(prunedItems);
  };
  var ui = function (editor, formats, onDone) {
    var pruned = prune(editor, formats);
    return $_b5x6ze147jkbnbeqw.sketch({
      formats: pruned,
  ...
  var setup = function (realm, editor) {
    var commandSketch = function (name) {
      return function () {
        return $_cwg4bm10ujkbnbddm.forToolbarCommand(editor, name);
      };
    };
    var stateCommandSketch = function (name) {
      return function () {
        return $_cwg4bm10ujkbnbddm.forToolbarStateCommand(editor, name);
      };
    };
    var actionSketch = function (name, query, action) {
      return function () {
        return $_cwg4bm10ujkbnbddm.forToolbarStateAction(editor, name, query, action);
      };
    };
    ...
    var forecolor = function () {
      return $_5zec3s12kjkbnbe4f.sketch(realm, editor);
    };
    var styleFormats = $_ccfl6f145jkbnbeq2.register(editor, editor.settings);
    var styleFormatsMenu = function () {
      return $_ccfl6f145jkbnbeq2.ui(editor, styleFormats, function () {
        editor.fire('scrollIntoView');
      });
    };
    var styleselect = function () {
      return $_cwg4bm10ujkbnbddm.forToolbar('style-formats', function (button) {
        ...
        Receiving.config({
          channels: wrapAll$1([
            $_7q8zmc10sjkbnbdd8.receive($_dni3jc109jkbnbd6c.orientationChanged(), Toggling.off),
            $_7q8zmc10sjkbnbdd8.receive($_dni3jc109jkbnbd6c.dropupDismissed(), Toggling.off)
          ])
        })
      ]));
    };
  ...
  var bind$2 = function (element, event, handler) {
    return $_8b6tcj15djkbnbfdg.bind(element, event, filter$1, handler);
  };
  var capture$1 = function (element, event, handler) {
    return $_8b6tcj15djkbnbfdg.capture(element, event, filter$1, handler);
  };
  var $_ed7rez15cjkbnbfd9 = {
    bind: bind$2,
    capture: capture$1
  };
  ...
  var getActualWidth = function (outerWindow) {
    var isIos = $_gfn29ky3jkbnbcjc.detect().os.isiOS();
  ...
  var onChange = function (outerWindow, listeners) {
    ...
    var orientationHandle = $_ed7rez15cjkbnbfd9.bind(win, 'orientationchange', change);
  ...
  var monitor = function (settings) {
    ...
    var handleTouchend = function (event) {
      ...
      var isSame = function (data) {
        return $_3nd6p8ytjkbnbcq4.eq(data.target(), event.target());
      };
  ...
  var monitor$1 = function (editorApi) {
    ...
    var onTouchend = function () {
      return $_ed7rez15cjkbnbfd9.bind(editorApi.body(), 'touchend', function (evt) {
        tapEvent.fireIfReady(evt, 'touchend');
      });
    };
    var onTouchmove = function () {
      return $_ed7rez15cjkbnbfd9.bind(editorApi.body(), 'touchmove', function (evt) {
  ...
  var $_8t70dz15ijkbnbfft = { monitor: monitor$1 };

  var isAndroid6 = $_gfn29ky3jkbnbcjc.detect().os.version.major >= 6;
  var initEvents = function (editorApi, toolstrip, alloy) {
    var tapping = $_8t70dz15ijkbnbfft.monitor(editorApi);
    var outerDoc = $_xmnonynjkbnbcov.owner(toolstrip);
    var isRanged = function (sel) {
      return !$_3nd6p8ytjkbnbcq4.eq(sel.start(), sel.finish()) || sel.soffset() !== sel.foffset();
    };
    var hasRangeInUi = function () {
      return $_1jph6e101jkbnbd4i.active(outerDoc).filter(function (input) {
        return $_391003ykjkbnbcok.name(input) === 'input';
    ...
    var listeners = [
      $_ed7rez15cjkbnbfd9.bind(editorApi.body(), 'touchstart', function (evt) {
        editorApi.onTouchContent();
        tapping.fireTouchstart(evt);
      }),
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_ed7rez15cjkbnbfd9.bind(toolstrip, 'touchstart', function (evt) {
        editorApi.onTouchToolstrip();
      }),
      editorApi.onToReading(function () {
        $_1jph6e101jkbnbd4i.blur(editorApi.body());
      }),
      ...
      $_ed7rez15cjkbnbfd9.bind(Element$$1.fromDom(editorApi.win()), 'blur', function () {
        alloy.getByDom(toolstrip).each(Toggling.off);
      }),
      $_ed7rez15cjkbnbfd9.bind(outerDoc, 'select', updateMargin),
      $_ed7rez15cjkbnbfd9.bind(editorApi.doc(), 'selectionchange', updateMargin)
    ]);
    var destroy = function () {
  ...
  var $_762sh115hjkbnbfes = { initEvents: initEvents };

  var safeParse = function (element, attribute) {
    var parsed = parseInt($_elmynfzwjkbnbd3c.get(element, attribute), 10);
    return isNaN(parsed) ? 0 : parsed;
  };
  var $_6s5ctt15mjkbnbfhf = { safeParse: safeParse };
  ...
  var api$3 = NodeValue($_391003ykjkbnbcok.isText, 'text');
  ...
  var getEnd = function (element) {
    return $_391003ykjkbnbcok.name(element) === 'img' ? 1 : $_5f9md715pjkbnbfii.getOption(element).fold(function () {
      return $_xmnonynjkbnbcov.children(element).length;
    }, function (v) {
      return v.length;
    });
  };
  ...
  var isTextNodeWithCursorPosition = function (el) {
    return $_5f9md715pjkbnbfii.getOption(el).filter(function (text) {
  ...
  var isCursorPosition = function (elem) {
    ...
    return hasCursorPosition || contains(elementsWithCursorPosition, $_391003ykjkbnbcok.name(elem));
  };
  var $_cirkny15ojkbnbfib = {
    getEnd: getEnd,
    isEnd: isEnd,
    isStart: isStart,
  ...
  var getStart$1 = function (selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return $_8vw5ju15sjkbnbfja.getStart(startSitu);
      },
  ...
  var getWin = function (selection) {
    ...
    return $_xmnonynjkbnbcov.defaultView(start);
  };
  var $_4lqaib15rjkbnbfiy = {
  ...
  var makeRange = function (start, soffset, finish, foffset) {
    var doc = $_xmnonynjkbnbcov.owner(start);
  ...
  var after$2 = function (start, soffset, finish, foffset) {
    var r = makeRange(start, soffset, finish, foffset);
    var same = $_3nd6p8ytjkbnbcq4.eq(start, finish) && soffset === foffset;
    return r.collapsed && !same;
  };
  var $_3n7b1i15ujkbnbfjv = {
    after: after$2,
  ...
  var $_hx2dv15vjkbnbfjy = { fromElements: fromElements };
  ...
  var getRanges = function (win, selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return {
          ltr: cached(function () {
            return $_azbqm815wjkbnbfk7.relativeToNative(win, startSitu, finishSitu);
          }),
          rtl: cached(function () {
            return Option.some($_azbqm815wjkbnbfk7.relativeToNative(win, finishSitu, startSitu));
          })
        };
      },
      exact: function (start, soffset, finish, foffset) {
        return {
          ltr: cached(function () {
            return $_azbqm815wjkbnbfk7.exactToNative(win, start, soffset, finish, foffset);
          }),
          rtl: cached(function () {
            return Option.some($_azbqm815wjkbnbfk7.exactToNative(win, finish, foffset, start, soffset));
          })
        };
      }
    });
  ...
  var locateOffset = function (doc, textnode, x, y, rect) {
    ...
    var length = $_5f9md715pjkbnbfii.get(textnode).length;
    var offset = $_21q437160jkbnbfls.searchForPoint(rectForOffset, x, y, rect.right, length);
  ...
  var locate$1 = function (doc, node, x, y) {
    ...
    var foundRect = findMap(rects, function (rect) {
      return $_21q437160jkbnbfls.inRect(rect, x, y) ? Option.some(rect) : Option.none();
    });
    return foundRect.map(function (rect) {
      return locateOffset(doc, node, x, y, rect);
    });
  };
  var $_6tg55161jkbnbflv = { locate: locate$1 };

  var searchInChildren = function (doc, node, x, y) {
    var r = doc.dom().createRange();
    var nodes = $_xmnonynjkbnbcov.children(node);
    return findMap(nodes, function (n) {
      r.selectNode(n.dom());
      return $_21q437160jkbnbfls.inRect(r.getBoundingClientRect(), x, y) ? locateNode(doc, n, x, y) : Option.none();
    });
  };
  var locateNode = function (doc, node, x, y) {
    var locator = $_391003ykjkbnbcok.isText(node) ? $_6tg55161jkbnbflv.locate : searchInChildren;
  ...
  var $_cf982e15zjkbnbflg = { locate: locate$2 };

  var first$3 = function (element) {
    return $_c6nan6103jkbnbd52.descendant(element, $_cirkny15ojkbnbfib.isCursorPosition);
  };
  var last$2 = function (element) {
    return descendantRtl(element, $_cirkny15ojkbnbfib.isCursorPosition);
  };
  var descendantRtl = function (scope, predicate) {
    var descend = function (element) {
      var children = $_xmnonynjkbnbcov.children(element);
  ...
  var locateInElement = function (doc, node, x) {
    ...
    var f = collapseDirection === COLLAPSE_TO_LEFT ? $_9hest7163jkbnbfme.first : $_9hest7163jkbnbfme.last;
  ...
  var search$1 = function (doc, node, x) {
    var f = $_xmnonynjkbnbcov.children(node).length === 0 ? locateInEmpty : locateInElement;
    return f(doc, node, x);
  };
  var $_fwt5cy162jkbnbfm7 = { search: search$1 };
  ...
  var searchTextNodes = function (doc, node, x, y) {
    ...
    var boundedX = Math.max(rect.left, Math.min(rect.right, x));
    var boundedY = Math.max(rect.top, Math.min(rect.bottom, y));
    return $_cf982e15zjkbnbflg.locate(doc, node, boundedX, boundedY);
  };
  var searchFromPoint = function (doc, x, y) {
    return Element$$1.fromPoint(doc, x, y).bind(function (elem) {
      var fallback = function () {
        return $_fwt5cy162jkbnbfm7.search(doc, elem, x);
      };
      return $_xmnonynjkbnbcov.children(elem).length === 0 ? fallback() : searchTextNodes(doc, elem, x, y).orThunk(fallback);
    });
  };
  ...
  var fromPoint$1 = function (win, x, y) {
    ...
    return availableSearch(doc, x, y).map(function (rng) {
      return $_4lqaib15rjkbnbfiy.range(Element$$1.fromDom(rng.startContainer), rng.startOffset, Element$$1.fromDom(rng.endContainer), rng.endOffset);
    });
  };
  var $_5ojbka15yjkbnbfl8 = { fromPoint: fromPoint$1 };

  var withinContainer = function (win, ancestor, outerRange, selector) {
    var innerRange = $_azbqm815wjkbnbfk7.create(win);
    var self = $_dgipdcyyjkbnbcrr.is(ancestor, selector) ? [ancestor] : [];
    var elements = self.concat($_bhdqux119jkbnbdis.descendants(ancestor, selector));
    return filter(elements, function (elem) {
      $_azbqm815wjkbnbfk7.selectNodeContentsUsing(innerRange, elem);
      return $_azbqm815wjkbnbfk7.isWithin(outerRange, innerRange);
    });
  };
  var find$3 = function (win, selection, selector) {
    var outerRange = $_36e0wn15xjkbnbfkn.asLtrRange(win, selection);
    var ancestor = Element$$1.fromDom(outerRange.commonAncestorContainer);
    return $_391003ykjkbnbcok.isElement(ancestor) ? withinContainer(win, ancestor, outerRange, selector) : [];
  };
  var $_fur2sp164jkbnbfmm = { find: find$3 };

  var beforeSpecial = function (element, offset) {
    var name = $_391003ykjkbnbcok.name(element);
    if ('input' === name)
      return $_8vw5ju15sjkbnbfja.after(element);
    else if (!contains([
        'br',
        'img'
      ], name))
      return $_8vw5ju15sjkbnbfja.on(element, offset);
    else
      return offset === 0 ? $_8vw5ju15sjkbnbfja.before(element) : $_8vw5ju15sjkbnbfja.after(element);
  };
  var preprocessRelative = function (startSitu, finishSitu) {
    var start = startSitu.fold($_8vw5ju15sjkbnbfja.before, beforeSpecial, $_8vw5ju15sjkbnbfja.after);
    var finish = finishSitu.fold($_8vw5ju15sjkbnbfja.before, beforeSpecial, $_8vw5ju15sjkbnbfja.after);
    return $_4lqaib15rjkbnbfiy.relative(start, finish);
  };
  var preprocessExact = function (start, soffset, finish, foffset) {
    var startSitu = beforeSpecial(start, soffset);
    var finishSitu = beforeSpecial(finish, foffset);
    return $_4lqaib15rjkbnbfiy.relative(startSitu, finishSitu);
  };
  ...
  var doSetRange = function (win, start, soffset, finish, foffset) {
    var rng = $_azbqm815wjkbnbfk7.exactToNative(win, start, soffset, finish, foffset);
    doSetNativeRange(win, rng);
  };
  var findWithin = function (win, selection, selector) {
    return $_fur2sp164jkbnbfmm.find(win, selection, selector);
  };
  ...
  var setRangeFromRelative = function (win, relative) {
    return $_36e0wn15xjkbnbfkn.diagnose(win, relative).match({
      ltr: function (start, soffset, finish, foffset) {
  ...
  var setExact = function (win, start, soffset, finish, foffset) {
    var relative = $_f3h2gc165jkbnbfmx.preprocessExact(start, soffset, finish, foffset);
    setRangeFromRelative(win, relative);
  };
  var setRelative = function (win, startSitu, finishSitu) {
    var relative = $_f3h2gc165jkbnbfmx.preprocessRelative(startSitu, finishSitu);
    setRangeFromRelative(win, relative);
  };
  var toNative = function (selection) {
    var win = $_4lqaib15rjkbnbfiy.getWin(selection).dom();
    var getDomRange = function (start, soffset, finish, foffset) {
      return $_azbqm815wjkbnbfk7.exactToNative(win, start, soffset, finish, foffset);
    };
    var filtered = $_f3h2gc165jkbnbfmx.preprocess(selection);
    return $_36e0wn15xjkbnbfkn.diagnose(win, filtered).match({
      ltr: getDomRange,
      rtl: getDomRange
    });
  };
  var readRange = function (selection) {
    if (selection.rangeCount > 0) {
      ...
      return Option.some($_4lqaib15rjkbnbfiy.range(Element$$1.fromDom(firstRng.startContainer), firstRng.startOffset, Element$$1.fromDom(lastRng.endContainer), lastRng.endOffset));
    } else {
      return Option.none();
    }
  };
  var doGetExact = function (selection) {
    ...
    return $_3n7b1i15ujkbnbfjv.after(anchorNode, selection.anchorOffset, focusNode, selection.focusOffset) ? Option.some($_4lqaib15rjkbnbfiy.range(Element$$1.fromDom(selection.anchorNode), selection.anchorOffset, Element$$1.fromDom(selection.focusNode), selection.focusOffset)) : readRange(selection);
  };
  var setToElement = function (win, element) {
    var rng = $_azbqm815wjkbnbfk7.selectNodeContents(win, element);
    doSetNativeRange(win, rng);
  };
  ...
  var get$13 = function (win) {
    return getExact(win).map(function (range) {
      return $_4lqaib15rjkbnbfiy.exact(range.start(), range.soffset(), range.finish(), range.foffset());
    });
  };
  var getFirstRect$1 = function (win, selection) {
    var rng = $_36e0wn15xjkbnbfkn.asLtrRange(win, selection);
    return $_azbqm815wjkbnbfk7.getFirstRect(rng);
  };
  var getBounds$1 = function (win, selection) {
    var rng = $_36e0wn15xjkbnbfkn.asLtrRange(win, selection);
    return $_azbqm815wjkbnbfk7.getBounds(rng);
  };
  var getAtPoint = function (win, x, y) {
    return $_5ojbka15yjkbnbfl8.fromPoint(win, x, y);
  };
  var getAsString = function (win, selection) {
    var rng = $_36e0wn15xjkbnbfkn.asLtrRange(win, selection);
    return $_azbqm815wjkbnbfk7.toString(rng);
  };
  ...
  var clone$3 = function (win, selection) {
    var rng = $_36e0wn15xjkbnbfkn.asLtrRange(win, selection);
    return $_azbqm815wjkbnbfk7.cloneFragment(rng);
  };
  var replace = function (win, selection, elements) {
    var rng = $_36e0wn15xjkbnbfkn.asLtrRange(win, selection);
    var fragment = $_hx2dv15vjkbnbfjy.fromElements(elements, win.document);
    $_azbqm815wjkbnbfk7.replaceWith(rng, fragment);
  };
  var deleteAt = function (win, selection) {
    var rng = $_36e0wn15xjkbnbfkn.asLtrRange(win, selection);
    $_azbqm815wjkbnbfk7.deleteContents(rng);
  };
  var isCollapsed = function (start, soffset, finish, foffset) {
    return $_3nd6p8ytjkbnbcq4.eq(start, finish) && soffset === foffset;
  };
  var $_awr1z215tjkbnbfjm = {
    setExact: setExact,
    getExact: getExact,
    get: get$13,
  ...
  var getRectsFromRange = function (range$$1) {
    if (!range$$1.collapsed) {
      ...
      return $_xmnonynjkbnbcov.parent(start_1).bind(function (parent) {
        var selection = $_4lqaib15rjkbnbfiy.exact(start_1, range$$1.startOffset, parent, $_cirkny15ojkbnbfib.getEnd(parent));
        var optRect = $_awr1z215tjkbnbfjm.getFirstRect(range$$1.startContainer.ownerDocument.defaultView, selection);
  ...
  var $_1w9rne15njkbnbfhn = { getRectangles: getRectangles };
  ...
  var resume = function (cWin) {
    ...
    var inInput = $_1jph6e101jkbnbd4i.active().exists(function (elem) {
      return contains([
        'input',
        'textarea'
      ], $_391003ykjkbnbcok.name(elem));
    });
    var transaction = inInput ? autocompleteHack() : apply;
    transaction(function () {
      $_1jph6e101jkbnbd4i.active().each($_1jph6e101jkbnbd4i.blur);
      $_1jph6e101jkbnbd4i.focus(iBody);
    });
  };
  var $_fi4fzb166jkbnbfn5 = { resume: resume };

  var EXTRA_SPACING = 50;
  var data = 'data-' + $_b6jmid10tjkbnbddg.resolve('last-outer-height');
  var setLastHeight = function (cBody, value) {
    $_elmynfzwjkbnbd3c.set(cBody, data, value);
  };
  var getLastHeight = function (cBody) {
    return $_6s5ctt15mjkbnbfhf.safeParse(cBody, data);
  };
  ...
  var getBounds$2 = function (cWin) {
    var rects = $_1w9rne15njkbnbfhn.getRectangles(cWin);
  ...
  var setup$1 = function (outerWindow, cWin) {
    ...
    var toEditing = function () {
      $_fi4fzb166jkbnbfn5.resume(cWin);
    };
    var onResize = $_ed7rez15cjkbnbfd9.bind(Element$$1.fromDom(outerWindow), 'resize', function () {
  ...
  var $_djdi5k15ljkbnbfgw = { setup: setup$1 };
  ...
  var getSelectionFromFrame = function (frame) {
    ...
    return optWin.bind($_awr1z215tjkbnbfjm.getExact);
  };
  ...
  var getOrListen = function (editor, doc, name, type) {
    return editor[name].getOrThunk(function () {
      return function (handler) {
        return $_ed7rez15cjkbnbfd9.bind(doc, type, handler);
      };
    });
  };
  ...
  var getActiveApi = function (editor) {
    ...
    var tryFallbackBox = function (win) {
      ...
      return $_awr1z215tjkbnbfjm.getExact(win).filter(isCollapsed).bind(toStartRect);
    };
      ...
      return getDocFromFrame(frame).bind(function (doc) {
        return getWinFromFrame(frame).map(function (win) {
          ...
          var getCursorBox = editor.getCursorBox.getOrThunk(function () {
            return function () {
              return $_awr1z215tjkbnbfjm.get(win).bind(function (sel) {
                return $_awr1z215tjkbnbfjm.getFirstRect(win, sel).orThunk(function () {
          ...
          var setSelection = editor.setSelection.getOrThunk(function () {
            return function (start, soffset, finish, foffset) {
              $_awr1z215tjkbnbfjm.setExact(win, start, soffset, finish, foffset);
            };
          });
          var clearSelection = editor.clearSelection.getOrThunk(function () {
            return function () {
              $_awr1z215tjkbnbfjm.clear(win);
            };
          });
          return {
            body: constant(body),
  ...
  var isAndroid = $_gfn29ky3jkbnbcjc.detect().os.isAndroid();
  var matchColor = function (editorBody) {
    var color = $_5wkv2x116jkbnbdhj.get(editorBody, 'background-color');
    return color !== undefined && color !== '' ? 'background-color:' + color + '!important' : bgFallback;
  };
  var clobberStyles = function (container, editorBody) {
    var gatherSibilings = function (element) {
      var siblings = $_bhdqux119jkbnbdis.siblings(element, '*');
      return siblings;
    };
    var clobber = function (clobberStyle) {
      return function (element) {
        var styles = $_elmynfzwjkbnbd3c.get(element, 'style');
        var backup = styles === undefined ? 'no-styles' : styles.trim();
        if (backup === clobberStyle) {
          return;
        } else {
          $_elmynfzwjkbnbd3c.set(element, attr, backup);
          $_elmynfzwjkbnbd3c.set(element, 'style', clobberStyle);
        }
      };
    };
    var ancestors = $_bhdqux119jkbnbdis.ancestors(container, '*');
  ...
  var restoreStyles = function () {
    var clobberedEls = $_bhdqux119jkbnbdis.all('[' + attr + ']');
    each$1(clobberedEls, function (element) {
      var restore = $_elmynfzwjkbnbd3c.get(element, attr);
      if (restore !== 'no-styles') {
        $_elmynfzwjkbnbd3c.set(element, 'style', restore);
      } else {
        $_elmynfzwjkbnbd3c.remove(element, 'style');
      }
      $_elmynfzwjkbnbd3c.remove(element, attr);
  ...
  var $_9w1ned168jkbnbfoe = {
    clobberStyles: clobberStyles,
    restoreStyles: restoreStyles
  };

  var tag = function () {
    var head = $_23b1y811bjkbnbdj5.first('head').getOrDie();
    var nu = function () {
      var meta = Element$$1.fromTag('meta');
      $_elmynfzwjkbnbd3c.set(meta, 'name', 'viewport');
      $_4k9tcqymjkbnbcor.append(head, meta);
      return meta;
    };
    var element = $_23b1y811bjkbnbdj5.first('meta[name="viewport"]').getOrThunk(nu);
    var backup = $_elmynfzwjkbnbd3c.get(element, 'content');
    var maximize = function () {
      $_elmynfzwjkbnbd3c.set(element, 'content', 'width=device-width, initial-scale=1.0, user-scalable=no, maximum-scale=1.0');
    };
    var restore = function () {
      if (backup !== undefined && backup !== null && backup.length > 0) {
        $_elmynfzwjkbnbd3c.set(element, 'content', backup);
      } else {
        $_elmynfzwjkbnbd3c.set(element, 'content', 'user-scalable=yes');
      }
    };
    return {
      maximize: maximize,
  ...
  var $_g37bld169jkbnbfow = { tag: tag };

  var create$5 = function (platform, mask) {
    var meta = $_g37bld169jkbnbfow.tag();
    var androidApi = api$2();
    var androidEvents = api$2();
    var enter = function () {
      mask.hide();
      $_27wkbdzujkbnbd36.add(platform.container, $_b6jmid10tjkbnbddg.resolve('fullscreen-maximized'));
      $_27wkbdzujkbnbd36.add(platform.container, $_b6jmid10tjkbnbddg.resolve('android-maximized'));
      meta.maximize();
      $_27wkbdzujkbnbd36.add(platform.body, $_b6jmid10tjkbnbddg.resolve('android-scroll-reload'));
      androidApi.set($_djdi5k15ljkbnbfgw.setup(platform.win, $_drhya6167jkbnbfnq.getWin(platform.editor).getOrDie('no')));
      $_drhya6167jkbnbfnq.getActiveApi(platform.editor).each(function (editorApi) {
        $_9w1ned168jkbnbfoe.clobberStyles(platform.container, editorApi.body());
        androidEvents.set($_762sh115hjkbnbfes.initEvents(editorApi, platform.toolstrip, platform.alloy));
      });
    };
    var exit = function () {
      meta.restore();
      mask.show();
      $_27wkbdzujkbnbd36.remove(platform.container, $_b6jmid10tjkbnbddg.resolve('fullscreen-maximized'));
      $_27wkbdzujkbnbd36.remove(platform.container, $_b6jmid10tjkbnbddg.resolve('android-maximized'));
      $_9w1ned168jkbnbfoe.restoreStyles();
      $_27wkbdzujkbnbd36.remove(platform.body, $_b6jmid10tjkbnbddg.resolve('android-scroll-reload'));
      androidEvents.clear();
      androidApi.clear();
    };
    return {
  ...
  var $_eumht215gjkbnbfei = { create: create$5 };
  ...
  var sketch$10 = function (onView, translate) {
    var memIcon = record(Container.sketch({
      ...
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_b6jmid10tjkbnbddg.resolve('mask-tap-icon-selected'),
          toggleOnExecute: false
        })])
    }));
    ...
    return Container.sketch({
      ...
      components: [Container.sketch({
          ...
          components: [Button.sketch({
              ...
              buttonBehaviours: derive$2([Toggling.config({ toggleClass: $_b6jmid10tjkbnbddg.resolve('mask-tap-icon-selected') })])
            })]
        })]
    });
  };
  var $_7p6hiy16ajkbnbfpc = { sketch: sketch$10 };
  ...
  var MobileSchema = objOf([
    ...
    state$1('win', function (spec) {
      return $_xmnonynjkbnbcov.owner(spec.socket).dom().defaultView;
    }),
  ...
  var produce = function (raw) {
    ...
    $_5wkv2x116jkbnbdhj.set(mobile.toolstrip, 'width', '100%');
    var onTap = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_7p6hiy16ajkbnbfpc.sketch(onTap, mobile.translate));
    ...
    $_4k9tcqymjkbnbcor.append(mobile.container, mask.element());
    var mode = $_eumht215gjkbnbfei.create(mobile, maskApi);
    return {
  ...
  var $_7fc2wy15fjkbnbfe0 = { produce: produce };
  ...
  var dataHorizontal = 'data-' + $_b6jmid10tjkbnbddg.resolve('horizontal-scroll');
  ...
  var markAsHorizontal = function (container) {
    $_elmynfzwjkbnbd3c.set(container, dataHorizontal, 'true');
  };
  var hasScroll = function (container) {
    return $_elmynfzwjkbnbd3c.get(container, dataHorizontal) === 'true' ? hasHorizontalScroll(container) : hasVerticalScroll(container);
  };
  var exclusive = function (scope, selector) {
    return $_ed7rez15cjkbnbfd9.bind(scope, 'touchmove', function (event) {
      $_23b1y811bjkbnbdj5.closest(event.target(), selector).filter(hasScroll).fold(function () {
        event.raw().preventDefault();
      }, noop);
    });
  };
  var $_geyfh416ijkbnbft4 = {
    exclusive: exclusive,
  ...
  function ScrollingToolbar () {
    var makeGroup = function (gSpec) {
      ...
      return {
        ...
        tgroupBehaviours: derive$2([config('adhoc-scrollable-toolbar', gSpec.scrollable === true ? [runOnInit(function (component, simulatedEvent) {
              $_5wkv2x116jkbnbdhj.set(component.element(), 'overflow-x', 'auto');
              $_geyfh416ijkbnbft4.markAsHorizontal(component.element());
              $_25ej2t159jkbnbfc1.register(component.element());
            })] : [])]),
        components: [Container.sketch({ components: [ToolbarGroup.parts().items({})] })],
        markers: { itemClass: $_b6jmid10tjkbnbddg.resolve('toolbar-group-item') },
        items: gSpec.items
      };
    };
    var toolbar = build$1(Toolbar.sketch({
      ...
      toolbarBehaviours: derive$2([
        Toggling.config({
          toggleClass: $_b6jmid10tjkbnbddg.resolve('context-toolbar'),
          toggleOnExecute: false,
          aria: { mode: 'none' }
        }),
    ...
    var wrapper = build$1(Container.sketch({
      dom: { classes: [$_b6jmid10tjkbnbddg.resolve('toolstrip')] },
      components: [premade$1(toolbar)],
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_b6jmid10tjkbnbddg.resolve('android-selection-context-toolbar'),
          toggleOnExecute: false
        })])
    }));
  ...
  var disableTransitions = function (component, slideConfig) {
    ...
    $_c411m314mjkbnbf1s.remove(root, [
      slideConfig.shrinkingClass(),
      slideConfig.growingClass()
    ]);
  };
  var setShrunk = function (component, slideConfig) {
    $_27wkbdzujkbnbd36.remove(component.element(), slideConfig.openClass());
    $_27wkbdzujkbnbd36.add(component.element(), slideConfig.closedClass());
    $_5wkv2x116jkbnbdhj.set(component.element(), getDimensionProperty(slideConfig), '0px');
    $_5wkv2x116jkbnbdhj.reflow(component.element());
  };
  ...
  var setGrown = function (component, slideConfig) {
    $_27wkbdzujkbnbd36.remove(component.element(), slideConfig.closedClass());
    $_27wkbdzujkbnbd36.add(component.element(), slideConfig.openClass());
    $_5wkv2x116jkbnbdhj.remove(component.element(), getDimensionProperty(slideConfig));
  };
  var doImmediateShrink = function (component, slideConfig, slideState) {
    slideState.setCollapsed();
    $_5wkv2x116jkbnbdhj.set(component.element(), getDimensionProperty(slideConfig), getDimension(slideConfig, component.element()));
    $_5wkv2x116jkbnbdhj.reflow(component.element());
  ...
  var doStartShrink = function (component, slideConfig, slideState) {
    ...
    $_5wkv2x116jkbnbdhj.reflow(component.element());
    var root = getAnimationRoot(component, slideConfig);
    $_27wkbdzujkbnbd36.add(root, slideConfig.shrinkingClass());
    setShrunk(component, slideConfig);
    slideConfig.onStartShrink()(component);
  };
  var doStartGrow = function (component, slideConfig, slideState) {
    ...
    var root = getAnimationRoot(component, slideConfig);
    $_27wkbdzujkbnbd36.add(root, slideConfig.growingClass());
    setGrown(component, slideConfig);
    $_5wkv2x116jkbnbdhj.set(component.element(), getDimensionProperty(slideConfig), fullSize);
  ...
  var isGrowing = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_27wkbdzujkbnbd36.has(root, slideConfig.growingClass()) === true;
  };
  var isShrinking = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_27wkbdzujkbnbd36.has(root, slideConfig.shrinkingClass()) === true;
  };
  ...
  var events$10 = function (slideConfig, slideState) {
    return derive([run(transitionend(), function (component, simulatedEvent) {
        ...
        if (raw.propertyName === slideConfig.dimension().property()) {
          disableTransitions(component, slideConfig);
          if (slideState.isExpanded()) {
            $_5wkv2x116jkbnbdhj.remove(component.element(), slideConfig.dimension().property());
          }
    ...
    strictOf('dimension', choose$1('property', {
      width: [
        ...
        output$1('getDimension', function (elem) {
          return $_9a05e6130jkbnbeas.get(elem) + 'px';
        })
      ],
      height: [
        output$1('property', 'height'),
        output$1('getDimension', function (elem) {
          return $_96oz3d115jkbnbdhf.get(elem) + 'px';
        })
      ]
    }))
  ];
  ...
  var build$2 = function (refresh, scrollIntoView) {
    var dropup = build$1(Container.sketch({
      dom: {
        tag: 'div',
        classes: [$_b6jmid10tjkbnbddg.resolve('dropup')]
      },
      components: [],
      containerBehaviours: derive$2([
        Replacing.config({}),
        Sliding.config({
          closedClass: $_b6jmid10tjkbnbddg.resolve('dropup-closed'),
          openClass: $_b6jmid10tjkbnbddg.resolve('dropup-open'),
          shrinkingClass: $_b6jmid10tjkbnbddg.resolve('dropup-shrinking'),
          growingClass: $_b6jmid10tjkbnbddg.resolve('dropup-growing'),
        ...
        $_7q8zmc10sjkbnbdd8.orientation(function (component, data) {
          disappear(noop);
        })
      ])
    }));
  ...
  var isDangerous = function (event$$1) {
    ...
    return keyEv.which === BACKSPACE()[0] && !contains([
      'input',
      'textarea'
    ], $_391003ykjkbnbcok.name(event$$1.target()));
  };
  var isFirefox = $_gfn29ky3jkbnbcjc.detect().browser.isFirefox();
  ...
  var bindFocus = function (container, handler) {
    if (isFirefox) {
      return $_ed7rez15cjkbnbfd9.capture(container, 'focus', handler);
    } else {
      return $_ed7rez15cjkbnbfd9.bind(container, 'focusin', handler);
    }
  };
  var bindBlur = function (container, handler) {
    if (isFirefox) {
      return $_ed7rez15cjkbnbfd9.capture(container, 'blur', handler);
    } else {
      return $_ed7rez15cjkbnbfd9.bind(container, 'focusout', handler);
    }
  };
  var setup$2 = function (container, rawSettings) {
    var settings = asRawOrDie('Getting GUI events settings', settingsSchema, rawSettings);
    var pointerEvents = $_gfn29ky3jkbnbcjc.detect().deviceType.isTouch() ? [
      'touchstart',
      'touchmove',
      'touchend',
      'gesturestart'
    ...
    var simpleEvents = map$1(pointerEvents.concat([
      ...
      return $_ed7rez15cjkbnbfd9.bind(container, type, function (event$$1) {
    ...
    var onKeydown = $_ed7rez15cjkbnbfd9.bind(container, 'keydown', function (event$$1) {
    ...
    var defaultView = $_xmnonynjkbnbcov.defaultView(container);
    var onWindowScroll = $_ed7rez15cjkbnbfd9.bind(defaultView, 'scroll', function (event$$1) {
  ...
  var doTriggerHandler = function (lookup, eventType, rawEvent, target, source, logger) {
    ...
    return handler.fold(function () {
      ...
      if (simulatedEvent.isStopped()) {
        ...
        return $_xmnonynjkbnbcov.parent(handlerInfo.element()).fold(function () {
  ...
  var closest$3 = function (target, transform, isRoot) {
    var delegate = $_c6nan6103jkbnbd52.closest(target, function (elem) {
  ...
  function Registry () {
    ...
    var failOnDuplicate = function (component, tagId) {
      ...
      if (conflict === component) {
        ...
        throw new Error('The tagId "' + tagId + '" is already used by: ' + element(conflict.element()) + '\nCannot use it for: ' + element(component.element()) + '\n' + 'The conflicting element is' + ($_bm7r6hyhjkbnbcnh.inBody(conflict.element()) ? ' ' : ' not ') + 'already in the DOM');
      }
    };
  ...
  var takeover = function (root) {
    var isAboveRoot = function (el) {
      return $_xmnonynjkbnbcov.parent(root.element()).fold(function () {
        return true;
      }, function (parent) {
        return $_3nd6p8ytjkbnbcq4.eq(el, parent);
      });
    };
    ...
    var systemApi = SystemApi({
      ...
      triggerFocus: function (target, originator) {
        read$2(target).fold(function () {
          $_1jph6e101jkbnbd4i.focus(target);
        }, function (_alloyId) {
    ...
    var addToWorld = function (component) {
      ...
      if (!$_391003ykjkbnbcok.isText(component.element())) {
    ...
    var destroy = function () {
      domEvents.unbind();
      $_9sor8jyzjkbnbcs4.remove(root.element());
    };
  ...
  var READ_ONLY_MODE_CLASS = constant($_b6jmid10tjkbnbddg.resolve('readonly-mode'));
  var EDIT_MODE_CLASS = constant($_b6jmid10tjkbnbddg.resolve('edit-mode'));
  function OuterContainer (spec) {
    var root = build$1(Container.sketch({
      dom: { classes: [$_b6jmid10tjkbnbddg.resolve('outer-container')].concat(spec.classes) },
  ...
  function AndroidRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_b6jmid10tjkbnbddg.resolve('android-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_5atsgs16jjkbnbftk.makeEditSwitch(webapp);
    var socket = $_5atsgs16jjkbnbftk.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_7fc2wy15fjkbnbfe0.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        w.exit();
    ...
    var updateMode = function (readOnly) {
      $_5atsgs16jjkbnbftk.updateMode(socket, switchToEdit, readOnly, alloy.root());
    };
    return {
  ...
  var input$1 = function (parent, operation) {
    ...
    $_5wkv2x116jkbnbdhj.setAll(input, {
      opacity: '0',
      position: 'absolute',
      top: '-1000px',
      left: '-1000px'
    });
    $_4k9tcqymjkbnbcor.append(parent, input);
    $_1jph6e101jkbnbd4i.focus(input);
    operation(input);
    $_9sor8jyzjkbnbcs4.remove(input);
  };
  var $_255sre173jkbnbg48 = { input: input$1 };
  ...
  var $_ebj4w3175jkbnbg55 = {
    refreshInput: refreshInput,
    refresh: refresh
  };

  var resume$1 = function (cWin, frame) {
    $_1jph6e101jkbnbd4i.active().each(function (active) {
      if (!$_3nd6p8ytjkbnbcq4.eq(active, frame)) {
        $_1jph6e101jkbnbd4i.blur(active);
      }
    });
    cWin.focus();
    $_1jph6e101jkbnbd4i.focus(Element$$1.fromDom(cWin.document.body));
    $_ebj4w3175jkbnbg55.refresh(cWin);
  };
  var $_g9y84h174jkbnbg4q = { resume: resume$1 };

  var stubborn = function (outerBody, cWin, page, frame) {
    var toEditing = function () {
      $_g9y84h174jkbnbg4q.resume(cWin, frame);
    };
    var toReading = function () {
      $_255sre173jkbnbg48.input(outerBody, $_1jph6e101jkbnbd4i.blur);
    };
    var captureInput = $_ed7rez15cjkbnbfd9.bind(page, 'keydown', function (evt) {
      if (!contains([
          'input',
          'textarea'
        ], $_391003ykjkbnbcok.name(evt.target()))) {
        toEditing();
      }
    });
  ...
  var initEvents$1 = function (editorApi, iosApi, toolstrip, socket, dropup) {
    ...
    var reposition = function () {
      var toolbarHeight = $_96oz3d115jkbnbdhf.get(toolstrip);
      iosApi.run(function (api) {
    ...
    var listeners = [
      ...
      $_ed7rez15cjkbnbfd9.bind(editorApi.doc(), 'touchend', function (touchEvent) {
        if ($_3nd6p8ytjkbnbcq4.eq(editorApi.html(), touchEvent.target()) || $_3nd6p8ytjkbnbcq4.eq(editorApi.body(), touchEvent.target())) {
        }
      }),
      $_ed7rez15cjkbnbfd9.bind(toolstrip, 'transitionend', function (transitionEvent) {
        if (transitionEvent.raw().propertyName === 'height') {
          reposition();
        }
      }),
      $_ed7rez15cjkbnbfd9.capture(toolstrip, 'touchstart', function (touchEvent) {
        saveSelectionFirst();
      ...
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_ed7rez15cjkbnbfd9.bind(editorApi.body(), 'click', function (event) {
        event.kill();
      }),
      $_ed7rez15cjkbnbfd9.bind(toolstrip, 'touchmove', function () {
  ...
  var $_abvobb176jkbnbg5b = { initEvents: initEvents$1 };

  function FakeSelection (win, frame) {
    var doc = win.document;
    var container = Element$$1.fromTag('div');
    $_27wkbdzujkbnbd36.add(container, $_b6jmid10tjkbnbddg.resolve('unfocused-selections'));
    $_4k9tcqymjkbnbcor.append(Element$$1.fromDom(doc.documentElement), container);
    var onTouch = $_ed7rez15cjkbnbfd9.bind(container, 'touchstart', function (event) {
      event.prevent();
      $_g9y84h174jkbnbg4q.resume(win, frame);
      clear();
    });
    var make = function (rectangle) {
      var span = Element$$1.fromTag('span');
      $_c411m314mjkbnbf1s.add(span, [
        $_b6jmid10tjkbnbddg.resolve('layer-editor'),
        $_b6jmid10tjkbnbddg.resolve('unfocused-selection')
      ]);
      $_5wkv2x116jkbnbdhj.setAll(span, {
    ...
    var update = function () {
      clear();
      var rectangles = $_1w9rne15njkbnbfhn.getRectangles(win);
      var spans = map$1(rectangles, make);
      $_abel80z0jkbnbcsb.append(container, spans);
    };
    var clear = function () {
      $_9sor8jyzjkbnbcs4.empty(container);
    };
    var destroy = function () {
      onTouch.unbind();
      $_9sor8jyzjkbnbcs4.remove(container);
    };
    var isActive = function () {
      return $_xmnonynjkbnbcov.children(container).length > 0;
    };
    return {
      update: update,
      isActive: isActive,
  ...
  var $_b6tmez17gjkbnbgb7 = { findDevice: findDevice };

  var softKeyboardLimits = function (outerWindow) {
    return $_b6tmez17gjkbnbgb7.findDevice(outerWindow.screen.width, outerWindow.screen.height);
  };
  var accountableKeyboardHeight = function (outerWindow) {
    var portrait = $_15kd4115bjkbnbfco.get(outerWindow).isPortrait();
  ...
  var getGreenzone = function (socket, dropup) {
    var outerWindow = $_xmnonynjkbnbcov.owner(socket).dom().defaultView;
    var viewportHeight = $_96oz3d115jkbnbdhf.get(socket) + $_96oz3d115jkbnbdhf.get(dropup);
  ...
  var updatePadding = function (contentBody, socket, dropup) {
    ...
    var deltaHeight = $_96oz3d115jkbnbdhf.get(socket) + $_96oz3d115jkbnbdhf.get(dropup) - greenzoneHeight;
    $_5wkv2x116jkbnbdhj.set(contentBody, 'padding-bottom', deltaHeight + 'px');
  };
  var $_3gsgfa17fjkbnbgap = {
  ...
  var yFixedData = 'data-' + $_b6jmid10tjkbnbddg.resolve('position-y-fixed');
  var yFixedProperty = 'data-' + $_b6jmid10tjkbnbddg.resolve('y-property');
  var yScrollingData = 'data-' + $_b6jmid10tjkbnbddg.resolve('scrolling');
  var windowSizeData = 'data-' + $_b6jmid10tjkbnbddg.resolve('last-window-height');
  var getYFixedData = function (element) {
    return $_6s5ctt15mjkbnbfhf.safeParse(element, yFixedData);
  };
  var getYFixedProperty = function (element) {
    return $_elmynfzwjkbnbd3c.get(element, yFixedProperty);
  };
  var getLastWindowSize = function (element) {
    return $_6s5ctt15mjkbnbfhf.safeParse(element, windowSizeData);
  };
  ...
  var classify = function (element) {
    ...
    var classifier = $_elmynfzwjkbnbd3c.get(element, yScrollingData) === 'true' ? classifyScrolling : classifyFixed;
    return classifier(element, offsetY);
  };
  var findFixtures = function (container) {
    var candidates = $_bhdqux119jkbnbdis.descendants(container, '[' + yFixedData + ']');
    return map$1(candidates, classify);
  };
  var takeoverToolbar = function (toolbar) {
    var oldToolbarStyle = $_elmynfzwjkbnbd3c.get(toolbar, 'style');
    $_5wkv2x116jkbnbdhj.setAll(toolbar, {
      position: 'absolute',
      top: '0px'
    });
    $_elmynfzwjkbnbd3c.set(toolbar, yFixedData, '0px');
    $_elmynfzwjkbnbd3c.set(toolbar, yFixedProperty, 'top');
    var restore = function () {
      $_elmynfzwjkbnbd3c.set(toolbar, 'style', oldToolbarStyle || '');
      $_elmynfzwjkbnbd3c.remove(toolbar, yFixedData);
      $_elmynfzwjkbnbd3c.remove(toolbar, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverViewport = function (toolbarHeight, height, viewport) {
    var oldViewportStyle = $_elmynfzwjkbnbd3c.get(viewport, 'style');
    $_25ej2t159jkbnbfc1.register(viewport);
    $_5wkv2x116jkbnbdhj.setAll(viewport, {
      position: 'absolute',
      height: height + 'px',
      width: '100%',
      top: toolbarHeight + 'px'
    });
    $_elmynfzwjkbnbd3c.set(viewport, yFixedData, toolbarHeight + 'px');
    $_elmynfzwjkbnbd3c.set(viewport, yScrollingData, 'true');
    $_elmynfzwjkbnbd3c.set(viewport, yFixedProperty, 'top');
    var restore = function () {
      $_25ej2t159jkbnbfc1.deregister(viewport);
      $_elmynfzwjkbnbd3c.set(viewport, 'style', oldViewportStyle || '');
      $_elmynfzwjkbnbd3c.remove(viewport, yFixedData);
      $_elmynfzwjkbnbd3c.remove(viewport, yScrollingData);
      $_elmynfzwjkbnbd3c.remove(viewport, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverDropup = function (dropup, toolbarHeight, viewportHeight) {
    var oldDropupStyle = $_elmynfzwjkbnbd3c.get(dropup, 'style');
    $_5wkv2x116jkbnbdhj.setAll(dropup, {
      position: 'absolute',
      bottom: '0px'
    });
    $_elmynfzwjkbnbd3c.set(dropup, yFixedData, '0px');
    $_elmynfzwjkbnbd3c.set(dropup, yFixedProperty, 'bottom');
    var restore = function () {
      $_elmynfzwjkbnbd3c.set(dropup, 'style', oldDropupStyle || '');
      $_elmynfzwjkbnbd3c.remove(dropup, yFixedData);
      $_elmynfzwjkbnbd3c.remove(dropup, yFixedProperty);
    };
    return { restore: restore };
  };
  var deriveViewportHeight = function (viewport, toolbarHeight, dropupHeight) {
    var outerWindow = $_xmnonynjkbnbcov.owner(viewport).dom().defaultView;
    var winH = outerWindow.innerHeight;
    $_elmynfzwjkbnbd3c.set(viewport, windowSizeData, winH + 'px');
    return winH - toolbarHeight - dropupHeight;
  };
  var takeover$1 = function (viewport, contentBody, toolbar, dropup) {
    var outerWindow = $_xmnonynjkbnbcov.owner(viewport).dom().defaultView;
    var toolbarSetup = takeoverToolbar(toolbar);
    var toolbarHeight = $_96oz3d115jkbnbdhf.get(toolbar);
    var dropupHeight = $_96oz3d115jkbnbdhf.get(dropup);
    ...
    var refresh = function () {
      if (isActive) {
        var newToolbarHeight = $_96oz3d115jkbnbdhf.get(toolbar);
        var dropupHeight_1 = $_96oz3d115jkbnbdhf.get(dropup);
        var newHeight = deriveViewportHeight(viewport, newToolbarHeight, dropupHeight_1);
        $_elmynfzwjkbnbd3c.set(viewport, yFixedData, newToolbarHeight + 'px');
        $_5wkv2x116jkbnbdhj.set(viewport, 'height', newHeight + 'px');
        $_5wkv2x116jkbnbdhj.set(dropup, 'bottom', -(newToolbarHeight + newHeight + dropupHeight_1) + 'px');
        $_3gsgfa17fjkbnbgap.updatePadding(contentBody, viewport, dropup);
      }
    };
    var setViewportOffset = function (newYOffset) {
      var offsetPx = newYOffset + 'px';
      $_elmynfzwjkbnbd3c.set(viewport, yFixedData, offsetPx);
      refresh();
    };
    $_3gsgfa17fjkbnbgap.updatePadding(contentBody, viewport, dropup);
    return {
  ...
  var $_e0z91617ejkbnbg99 = {
    findFixtures: findFixtures,
    takeover: takeover$1,
    getYFixedData: getYFixedData
  };

  var animator = $_8bryc617djkbnbg8z.create();
  var ANIMATION_STEP = 15;
  var NUM_TOP_ANIMATION_FRAMES = 10;
  var ANIMATION_RATE = 10;
  var lastScroll = 'data-' + $_b6jmid10tjkbnbddg.resolve('last-scroll-top');
  var getTop = function (element) {
    var raw = $_5wkv2x116jkbnbdhj.getRaw(element, 'top').getOr('0');
  ...
  var moveScrollAndTop = function (element, destination, finalTop) {
    return Future.nu(function (callback) {
      ...
      var update = function (newScroll) {
        ...
        $_5wkv2x116jkbnbdhj.set(element, 'top', getTop(element) + ANIMATION_STEP + 'px');
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_5wkv2x116jkbnbdhj.set(element, 'top', finalTop + 'px');
  ...
  var moveOnlyScroll = function (element, destination) {
    return Future.nu(function (callback) {
      var getCurrent = curry(getScrollTop, element);
      $_elmynfzwjkbnbd3c.set(element, lastScroll, getCurrent());
      var update = function (newScroll, abort) {
        var previous = $_6s5ctt15mjkbnbfhf.safeParse(element, lastScroll);
        if (previous !== element.dom().scrollTop) {
          abort(element.dom().scrollTop);
        } else {
          element.dom().scrollTop = newScroll;
          $_elmynfzwjkbnbd3c.set(element, lastScroll, newScroll);
        }
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_elmynfzwjkbnbd3c.set(element, lastScroll, destination);
        callback(destination);
      };
  ...
  var moveOnlyTop = function (element, destination) {
    return Future.nu(function (callback) {
      ...
      var update = function (newTop) {
        $_5wkv2x116jkbnbdhj.set(element, 'top', newTop + 'px');
      };
      var finish = function () {
        update(destination);
        callback(destination);
  ...
  var updateTop = function (element, amount) {
    var newTop = amount + $_e0z91617ejkbnbg99.getYFixedData(element) + 'px';
    $_5wkv2x116jkbnbdhj.set(element, 'top', newTop);
  };
  var moveWindowScroll = function (toolbar, viewport, destY) {
    var outerWindow = $_xmnonynjkbnbcov.owner(toolbar).dom().defaultView;
    return Future.nu(function (callback) {
  ...
  var scrollIntoView = function (cWin, socket, dropup, top, bottom) {
    var greenzone = $_3gsgfa17fjkbnbgap.getGreenzone(socket, dropup);
    var refreshCursor = curry($_ebj4w3175jkbnbg55.refresh, cWin);
    if (top > greenzone || bottom > greenzone) {
      $_avvlm4179jkbnbg7z.moveOnlyScroll(socket, socket.dom().scrollTop - greenzone + bottom).get(refreshCursor);
    } else if (top < 0) {
      $_avvlm4179jkbnbg7z.moveOnlyScroll(socket, socket.dom().scrollTop + top).get(refreshCursor);
    } else {
    }
  };
  var $_3x3nqu17ijkbnbgc2 = { scrollIntoView: scrollIntoView };
  ...
  var updateFixed = function (element, property, winY, offsetY) {
    ...
    $_5wkv2x116jkbnbdhj.set(element, property, destination + 'px');
    return Future.pure(offsetY);
  };
  var updateScrollingFixed = function (element, winY, offsetY) {
    var destTop = winY + offsetY;
    var oldProp = $_5wkv2x116jkbnbdhj.getRaw(element, 'top').getOr(offsetY);
    var delta = destTop - parseInt(oldProp, 10);
    var destScroll = element.dom().scrollTop + delta;
    return $_avvlm4179jkbnbg7z.moveScrollAndTop(element, destScroll, destTop);
  };
  ...
  var register$2 = function (toolstrip, socket, container, outerWindow, structure, cWin) {
    ...
    var scrollThrottle = last$3(function () {
      scroller.idle(function () {
        $_1xv1ai17jjkbnbgca.updatePositions(container, outerWindow.pageYOffset).get(function () {
    ...
    var onScroll = $_ed7rez15cjkbnbfd9.bind(Element$$1.fromDom(outerWindow), 'scroll', function () {
      if (outerWindow.pageYOffset < 0) {
        return;
      }
      scrollThrottle.throttle();
    });
    $_1xv1ai17jjkbnbgca.updatePositions(container, outerWindow.pageYOffset).get(identity);
  ...
  var setup$3 = function (bag) {
    ...
    var structure = $_e0z91617ejkbnbg99.takeover(socket, ceBody, toolstrip, dropup);
    var keyboardModel = keyboardType(bag.outerBody(), cWin, $_bm7r6hyhjkbnbcnh.body(), contentElement, toolstrip, toolbar);
    var toEditing = function () {
    ...
    var onOrientation = $_15kd4115bjkbnbfco.onChange(outerWindow, {
      onChange: noop,
    ...
    var scrollIntoView = function (top, bottom) {
      $_3x3nqu17ijkbnbgc2.scrollIntoView(cWin, socket, dropup, top, bottom);
    };
    var syncHeight = function () {
      $_5wkv2x116jkbnbdhj.set(contentElement, 'height', contentElement.dom().contentWindow.document.body.scrollHeight + 'px');
    };
    var setViewportOffset = function (newYOffset) {
      structure.setViewportOffset(newYOffset);
      $_avvlm4179jkbnbg7z.moveOnlyTop(socket, newYOffset).get(identity);
    };
    var destroy = function () {
      structure.restore();
      ...
      $_255sre173jkbnbg48.input($_bm7r6hyhjkbnbcnh.body(), $_1jph6e101jkbnbd4i.blur);
    };
    return {
      toEditing: toEditing,
      toReading: toReading,
  ...
  var $_8i6pvu177jkbnbg5z = { setup: setup$3 };
  ...
  var create$8 = function (platform, mask) {
    ...
    var enter = function () {
      ...
      $_drhya6167jkbnbfnq.getActiveApi(platform.editor).each(function (editorApi) {
        priorState.set({
          socketHeight: $_5wkv2x116jkbnbdhj.getRaw(platform.socket, 'height'),
          iframeHeight: $_5wkv2x116jkbnbdhj.getRaw(editorApi.frame(), 'height'),
          outerScroll: document.body.scrollTop
        });
        scrollEvents.set({ exclusives: $_geyfh416ijkbnbft4.exclusive(doc, '.' + $_25ej2t159jkbnbfc1.scrollable()) });
        $_27wkbdzujkbnbd36.add(platform.container, $_b6jmid10tjkbnbddg.resolve('fullscreen-maximized'));
        $_9w1ned168jkbnbfoe.clobberStyles(platform.container, editorApi.body());
        meta.maximize();
        $_5wkv2x116jkbnbdhj.set(platform.socket, 'overflow', 'scroll');
        $_5wkv2x116jkbnbdhj.set(platform.socket, '-webkit-overflow-scrolling', 'touch');
        $_1jph6e101jkbnbd4i.focus(editorApi.body());
        ...
        iosApi.set($_8i6pvu177jkbnbg5z.setup(setupBag({
          cWin: editorApi.win(),
          ...
          keyboardType: $_y2vtu172jkbnbg3q.stubborn,
        ...
        iosEvents.set($_abvobb176jkbnbg5b.initEvents(editorApi, iosApi, platform.toolstrip, platform.socket, platform.dropup));
      });
    };
    var exit = function () {
      meta.restore();
      ...
      priorState.on(function (s) {
        s.socketHeight.each(function (h) {
          $_5wkv2x116jkbnbdhj.set(platform.socket, 'height', h);
        });
        s.iframeHeight.each(function (h) {
          $_5wkv2x116jkbnbdhj.set(platform.editor.getFrame(), 'height', h);
        });
      ...
      $_27wkbdzujkbnbd36.remove(platform.container, $_b6jmid10tjkbnbddg.resolve('fullscreen-maximized'));
      $_9w1ned168jkbnbfoe.restoreStyles();
      $_25ej2t159jkbnbfc1.deregister(platform.toolbar);
      $_5wkv2x116jkbnbdhj.remove(platform.socket, 'overflow');
      $_5wkv2x116jkbnbdhj.remove(platform.socket, '-webkit-overflow-scrolling');
      $_1jph6e101jkbnbd4i.blur(platform.editor.getFrame());
      $_drhya6167jkbnbfnq.getActiveApi(platform.editor).each(function (editorApi) {
  ...
  var $_6pivla171jkbnbg2v = { create: create$8 };

  var produce$1 = function (raw) {
    var mobile = asRawOrDie('Getting IosWebapp schema', MobileSchema, raw);
    $_5wkv2x116jkbnbdhj.set(mobile.toolstrip, 'width', '100%');
    $_5wkv2x116jkbnbdhj.set(mobile.container, 'position', 'relative');
    var onView = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_7p6hiy16ajkbnbfpc.sketch(onView, mobile.translate));
    mobile.alloy.add(mask);
    var maskApi = {
      show: function () {
        mobile.alloy.add(mask);
    ...
    var mode = $_6pivla171jkbnbg2v.create(mobile, maskApi);
    return {
      setReadOnly: mobile.setReadOnly,
  ...
  var $_eh5z22170jkbnbg2b = { produce: produce$1 };

  function IosRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_b6jmid10tjkbnbddg.resolve('ios-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_5atsgs16jjkbnbftk.makeEditSwitch(webapp);
    var socket = $_5atsgs16jjkbnbftk.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_eh5z22170jkbnbg2b.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        Replacing.remove(socket, switchToEdit);
  ...
  var $_7qyy0o17mjkbnbgd5 = { derive: derive$4 };
  ...
  var fireChange$1 = function (realm, command, state) {
    realm.system().broadcastOn([$_dni3jc109jkbnbd6c.formatChanged()], {
      command: command,
      state: state
    });
  };
  ...
  var $_1zjd0x17pjkbnbgdp = { fireSkinLoaded: fireSkinLoaded };

  var READING = constant('toReading');
  var EDITING = constant('toEditing');
  global$1.add('mobile', function (editor) {
    var renderUI = function (args) {
      var cssUrls = $_7qyy0o17mjkbnbgd5.derive(editor);
      if (isSkinDisabled(editor) === false) {
        editor.contentCSS.push(cssUrls.content);
        global.DOM.styleSheetLoader.load(cssUrls.ui, $_1zjd0x17pjkbnbgdp.fireSkinLoaded(editor));
      } else {
        $_1zjd0x17pjkbnbgdp.fireSkinLoaded(editor)();
      }
      var doScrollIntoView = function () {
        editor.fire('scrollIntoView');
      };
      var wrapper = Element$$1.fromTag('div');
      var realm = $_gfn29ky3jkbnbcjc.detect().os.isAndroid() ? AndroidRealm(doScrollIntoView) : IosRealm(doScrollIntoView);
      var original = Element$$1.fromDom(args.targetNode);
      $_4k9tcqymjkbnbcor.after(original, wrapper);
      attachSystem(wrapper, realm.system());
      var findFocusIn = function (elem) {
        return $_1jph6e101jkbnbd4i.search(elem).bind(function (focused) {
          return realm.system().getByDom(focused).toOption();
        });
      };
      var outerWindow = args.targetNode.ownerDocument.defaultView;
      var orientation = $_15kd4115bjkbnbfco.onChange(outerWindow, {
        onChange: function () {
          var alloy = realm.system();
          alloy.broadcastOn([$_dni3jc109jkbnbd6c.orientationChanged()], { width: $_15kd4115bjkbnbfco.getActualWidth(outerWindow) });
        },
        onReady: noop
      });
      ...
      editor.on('init', function () {
        realm.init({
          editor: {
            ...
            onTouchContent: function () {
              var toolbar = Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_b6jmid10tjkbnbddg.resolve('toolbar')));
            ...
            onTapContent: function (evt) {
              ...
              if ($_391003ykjkbnbcok.name(target) === 'img') {
                editor.selection.select(target.dom());
                evt.kill();
              } else if ($_391003ykjkbnbcok.name(target) === 'a') {
                var component = realm.system().getByDom(Element$$1.fromDom(editor.editorContainer));
                component.each(function (container) {
                  if (Swapping.isAlpha(container)) {
                    $_fwvusz107jkbnbd62.openLink(target.dom());
                  }
                });
              }
            }
          ...
          toolstrip: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_b6jmid10tjkbnbddg.resolve('toolstrip'))),
          toolbar: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_b6jmid10tjkbnbddg.resolve('toolbar'))),
          dropup: realm.dropup(),
          alloy: realm.system(),
          translate: noop,
        ...
        var hideDropup = function () {
          realm.dropup().disappear(function () {
            realm.system().broadcastOn([$_dni3jc109jkbnbd6c.dropupDismissed()], {});
          });
        };
        var backToMaskGroup = {
          label: 'The first group',
          scrollable: false,
          items: [$_cwg4bm10ujkbnbddm.forToolbar('back', function () {
              editor.selection.collapse();
              realm.exit();
            }, {})]
        };
        var backToReadOnlyGroup = {
          ...
          scrollable: false,
          items: [$_cwg4bm10ujkbnbddm.forToolbar('readonly-back', function () {
        ...
        var features = $_37aah10ajkbnbd6j.setup(realm, editor);
        var items = $_37aah10ajkbnbd6j.detect(editor.settings, features);
        var actionGroup = {
        ...
        $_d9zc1e17ojkbnbgdc.init(realm, editor);
      });
      return {
