...
var inlite = (function () {
  ...
  var $_6ifo0t17xjkbnbhow = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_filjnr181jkbnbhp8.fromClientRect(clientRect)) : null;
  };
  var $_el5oe0180jkbnbhp4 = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_5dw8u717zjkbnbhp2.result(predicateIds[i].id, $_el5oe0180jkbnbhp4.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_5dw8u717zjkbnbhp2.result(predicateIds[x].id, $_el5oe0180jkbnbhp4.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_5dw8u717zjkbnbhp2.result(id, $_el5oe0180jkbnbhp4.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_5dw8u717zjkbnbhp2.result(id, $_el5oe0180jkbnbhp4.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_g3tucz18ajkbnbhpv.isArray(value)) {
      return value;
    } else if ($_g3tucz18ajkbnbhpv.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_g3tucz18ajkbnbhpv.isBoolean(value)) {
  ...
  var $_e6k1dn189jkbnbhpr = {
    getStringOr: getByTypeOr($_g3tucz18ajkbnbhpv.isString),
    getBoolOr: getByTypeOr($_g3tucz18ajkbnbhpv.isBoolean),
    getNumberOr: getByTypeOr($_g3tucz18ajkbnbhpv.isNumber),
    getHandlerOr: getByTypeOr($_g3tucz18ajkbnbhpv.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_g3tucz18ajkbnbhpv.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_filjnr181jkbnbhp8.toClientRect(targetRect),
        contentAreaRect: $_filjnr181jkbnbhp8.toClientRect(contentAreaRect),
        panelRect: $_filjnr181jkbnbhp8.toClientRect(panelRect)
      });
      return $_filjnr181jkbnbhp8.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_e6k1dn189jkbnbhpr.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_e6k1dn189jkbnbhpr.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_e6k1dn189jkbnbhpr.getHandlerOr(editor, 'inline_toolbar_position_handler', $_6lo02i18bjkbnbhpy.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_epv633186jkbnbhpl.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_nc2ev187jkbnbhpn.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_nc2ev187jkbnbhpn.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_7nyf1n185jkbnbhpi = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_6ifo0t17xjkbnbhow.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_bl4e4e182jkbnbhpb.fromContextToolbars(toolbars);
    result = $_5dw8u717zjkbnbhp2.match(editor, [
      $_1y9u9g17yjkbnbhoy.element(elements[0], contextToolbarsPredicateIds),
      $_8m93mf184jkbnbhpf.textSelection('text'),
      $_8m93mf184jkbnbhpf.emptyTextBlock(elements, 'insert'),
      $_1y9u9g17yjkbnbhoy.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_5dw8u717zjkbnbhp2.match(editor, [$_8m93mf184jkbnbhpf.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_7nyf1n185jkbnbhpi.load(editor, function () {
  ...
  var $_ikqii17tjkbnbhok = { renderUI: renderUI };
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_50ywu818pjkbnbhtg.parseBox(settings.border);
      self$$1.paddingBox = $_50ywu818pjkbnbhtg.parseBox(settings.padding);
      self$$1.marginBox = $_50ywu818pjkbnbhtg.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_1w9oxj18xjkbnbhue.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_50ywu818pjkbnbhtg.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_50ywu818pjkbnbhtg.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_50ywu818pjkbnbhtg.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_dqalja18wjkbnbhub.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_1w9oxj18xjkbnbhue.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_1w9oxj18xjkbnbhue.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_7k8c0118yjkbnbhuo = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_1w9oxj18xjkbnbhue.getUiContainer(self$$1);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_1w9oxj18xjkbnbhue.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_50ywu818pjkbnbhtg.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_50ywu818pjkbnbhtg.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_ikqii17tjkbnbhok.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_cs4wvv17sjkbnbhog = { get: get };
  ...
  var $_62x5kx19gjkbnbhxi = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_62x5kx19gjkbnbhxi.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_5s18mg19ejkbnbhx8 = { blobToBase64: blobToBase64 };
  ...
  var $_1fk24r19kjkbnbhxv = { pickFile: pickFile };
  ...
  var $_9uw4b119mjkbnbhyb = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_f98jut19ojkbnbhyh.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_f98jut19ojkbnbhyh.resolve(dom, bookmark));
  };
  ...
  var $_ff41e919njkbnbhye = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_9uw4b119mjkbnbhyb.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_ff41e919njkbnbhye.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_2rllhh19ljkbnbhxz.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_1fk24r19kjkbnbhxv.pickFile().then(function (files) {
          var blob = files[0];
          $_5s18mg19ejkbnbhx8.blobToBase64(blob).then(function (base64) {
            $_2rllhh19ljkbnbhxz.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_2rllhh19ljkbnbhxz.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_hmc1919djkbnbhx4 = { addToEditor: addToEditor };
  ...
  var $_83nzt019sjkbnbhys = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_g03ln319ujkbnbhz2.isAbsolute(href) && $_g03ln319ujkbnbhz2.isDomainLike(href) ? askAboutPrefix(editor, href) : global$12.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_2rllhh19ljkbnbhxz.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_2rllhh19ljkbnbhxz.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_95saeb19tjkbnbhyz = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_g3tucz18ajkbnbhpv.isArray(items)) {
      return items;
    } else if ($_g3tucz18ajkbnbhpv.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_g3tucz18ajkbnbhpv.isFunction(button)) {
            button = button();
          }
  ...
  var $_2if8wy19vjkbnbhz5 = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_2if8wy19vjkbnbhz5.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_2if8wy19vjkbnbhz5.create(editor, 'text', $_nc2ev187jkbnbhpn.getTextSelectionToolbarItems(editor)),
        $_2if8wy19vjkbnbhz5.create(editor, 'insert', $_nc2ev187jkbnbhpn.getInsertToolbarItems(editor)),
        $_95saeb19tjkbnbhyz.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_nc2ev187jkbnbhpn.getPositionHandler(editor);
      contentAreaRect = $_el5oe0180jkbnbhp4.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_6lo02i18bjkbnbhpy.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_6lo02i18bjkbnbhpy.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_83nzt019sjkbnbhys.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_6lo02i18bjkbnbhpy.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_el5oe0180jkbnbhp4.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_6lo02i18bjkbnbhpy.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_6lo02i18bjkbnbhpy.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_epv633186jkbnbhpl.fireBeforeRenderUI(editor);
  ...
  var isComment = function (element) {
    return type(element) === $_c08r1w1apjkbnbi3z.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$2($_c08r1w1apjkbnbi3z.ELEMENT);
  var isText = isType$2($_c08r1w1apjkbnbi3z.TEXT);
  var isDocument = isType$2($_c08r1w1apjkbnbi3z.DOCUMENT);
  var $_7jkerh1aojkbnbi3x = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_7jkerh1aojkbnbi3x.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_az6sdd1awjkbnbi5d = { toArray: toArray };

  var node = function () {
    var f = $_62x5kx19gjkbnbhxi.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_ddu64w1b2jkbnbi6x.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_ddu64w1b2jkbnbi6x.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_ddu64w1b2jkbnbi6x.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_8gkf5j1b6jkbnbi7n = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_8gkf5j1b6jkbnbi7n.browsers();
    var oses = $_8gkf5j1b6jkbnbi7n.oses();
    var browser = $_5temst1b5jkbnbi7f.detectBrowser(browsers, userAgent).fold($_4fhjmf1b1jkbnbi6q.unknown, $_4fhjmf1b1jkbnbi6q.nu);
    var os = $_5temst1b5jkbnbi7f.detectOs(oses, userAgent).fold($_bydcl71b3jkbnbi70.unknown, $_bydcl71b3jkbnbi70.nu);
  ...
  var $_1hq2oi1b0jkbnbi6n = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_1hq2oi1b0jkbnbi6n.detect(userAgent);
  });
  var $_1pomgf1azjkbnbi6g = { detect: detect$3 };

  var ELEMENT = $_c08r1w1apjkbnbi3z.ELEMENT;
  var DOCUMENT = $_c08r1w1apjkbnbi3z.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_2vhi51ayjkbnbi6d.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_1pomgf1azjkbnbi6g.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_fbyj5j1axjkbnbi5g = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_8wwcyg1bajkbnbi8e.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_fbyj5j1axjkbnbi5g.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_fbyj5j1axjkbnbi5g.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_az6sdd1awjkbnbi5d.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_az6sdd1awjkbnbi5d.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_n4ns31amjkbnbi3n.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_d04nbh1aqjkbnbi44.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_d04nbh1aqjkbnbi44.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_d04nbh1aqjkbnbi44.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_d04nbh1aqjkbnbi44.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_8wwcyg1bajkbnbi8e.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_2a2k571aljkbnbi3g.ancestors(scope, function (e) {
      return $_8wwcyg1bajkbnbi8e.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_2a2k571aljkbnbi3g.siblings(scope, function (e) {
      return $_8wwcyg1bajkbnbi8e.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_2a2k571aljkbnbi3g.children(scope, function (e) {
      return $_8wwcyg1bajkbnbi8e.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_8wwcyg1bajkbnbi8e.all(selector, scope);
  };
  var $_c7utpj1akjkbnbi3d = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_c7utpj1akjkbnbi3d.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_axm2sg1ahjkbnbi22 = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_axm2sg1ahjkbnbi22.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_n4ns31amjkbnbi3n.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_fbyj5j1axjkbnbi5g.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_8wwcyg1bajkbnbi8e.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_akmmr71bgjkbnbi9m.ancestor(scope, function (e) {
      return $_8wwcyg1bajkbnbi8e.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_akmmr71bgjkbnbi9m.sibling(scope, function (e) {
      return $_8wwcyg1bajkbnbi8e.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_akmmr71bgjkbnbi9m.child(scope, function (e) {
      return $_8wwcyg1bajkbnbi8e.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_8wwcyg1bajkbnbi8e.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_8wwcyg1bajkbnbi8e.is, ancestor$1, scope, selector, isRoot);
  };
  var $_e7khwq1bfjkbnbi9f = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_6kluug1bijkbnbiai = { register: register };
  ...
  var $_du79uf1bkjkbnbiao = { register: register$1 };
  ...
  var $_1da7831bljkbnbias = { register: register$2 };
  ...
  var $_edu4vq1bmjkbnbiaw = { register: register$3 };
  ...
  var $_bcqvig1bnjkbnbib1 = { register: register$4 };
  ...
  var $_e58x1bojkbnbib5 = { register: register$5 };
  ...
  var $_f6mm31bpjkbnbiba = { register: register$6 };
  ...
  var $_o1n7j1bqjkbnbibe = { register: register$7 };
  ...
  var $_397rat1brjkbnbibg = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_e7khwq1bfjkbnbi9f.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_bcqvig1bnjkbnbib1.register(editor);
    $_6kluug1bijkbnbiai.register(editor);
    $_f6mm31bpjkbnbiba.register(editor);
    $_o1n7j1bqjkbnbibe.register(editor);
    $_1da7831bljkbnbias.register(editor);
    $_du79uf1bkjkbnbiao.register(editor);
    $_edu4vq1bmjkbnbiaw.register(editor);
    $_397rat1brjkbnbibg.register(editor);
    $_e58x1bojkbnbib5.register(editor);
  };
  var $_gih72s1bejkbnbi91 = { setup: setup };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_dqalja18wjkbnbhub,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_2h4fha19ajkbnbhwq,
      Panel: Panel,
      Movable: $_7k8c0118yjkbnbhuo,
      Resizable: $_fstrps19bjkbnbhwv,
      ...
      FormatControls: $_gih72s1bejkbnbi91,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_gih72s1bejkbnbi91.setup(editor);
    $_hmc1919djkbnbhx4.addToEditor(editor, panel);
    return $_cs4wvv17sjkbnbhog.get(editor, panel);
  });
  function Theme () {
  }
