...
var modern = (function () {
  ...
  var $_2023mu0jkbnbasc = { addKeys: addKeys };
  ...
  var addContextualToolbars = function (editor) {
    ...
    var reposition = function (match, shouldShow) {
      ...
      var delta = $_4vlujeu4jkbnbatb.getUiContainerDelta(panel).getOr({
        x: 0,
        y: 0
      });
    ...
    var bindScrollEvent = function (panel) {
      if (!scrollContainer) {
        ...
        var uiContainer_1 = $_4vlujeu4jkbnbatb.getUiContainer(panel);
    ...
    var showContextToolbar = function (match) {
      ...
      panel = global$4.create({
        ...
        fixed: true,
        border: 1,
        items: $_abat3su7jkbnbaxw.createToolbar(editor, match.toolbar.items),
        oncancel: function () {
          editor.focus();
        }
      });
      $_4vlujeu4jkbnbatb.setUiContainer(editor, panel);
  ...
  var $_6mlm52u1jkbnbasr = { addContextualToolbars: addContextualToolbars };
  ...
  var $_1wxan5u8jkbnbay3 = { createMenuButtons: createMenuButtons };
  ...
  var resizeTo = function (editor, width, height) {
    ...
    $_cvdl8utzjkbnbas5.fireResizeEditor(editor);
  };
  var resizeBy = function (editor, dw, dh) {
    var elm = editor.getContentAreaContainer();
    resizeTo(editor, elm.clientWidth + dw, elm.clientHeight + dh);
  };
  var $_49qzggubjkbnbaza = {
    resizeTo: resizeTo,
    resizeBy: resizeBy
  };
  ...
  var fireSkinLoaded$1 = function (editor) {
    var done = function () {
      ...
      $_cvdl8utzjkbnbas5.fireSkinLoaded(editor);
    };
    return function () {
      if (editor.initialized) {
        done();
  ...
  var $_3uvjp7uejkbnbazm = { fireSkinLoaded: fireSkinLoaded$1 };
  ...
  var editAreaContainer = function (editor) {
    return {
      ...
      items: [
        editArea('0'),
        $_b3982vucjkbnbazf.createSidebar(editor)
      ]
    };
  };
  var render = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM$2.styleSheetLoader.load(args.skinUiCss, $_3uvjp7uejkbnbazm.fireSkinLoaded(editor));
    } else {
      $_3uvjp7uejkbnbazm.fireSkinLoaded(editor)();
    }
      ...
      items: [
        {
          ...
          items: [
            hasMenubar(editor) === false ? null : {
              type: 'menubar',
              border: '0 0 1 0',
              items: $_1wxan5u8jkbnbay3.createMenuButtons(editor)
            },
            $_abat3su7jkbnbaxw.createToolbars(editor, getToolbarSize(editor))
          ]
        },
        $_b3982vucjkbnbazf.hasSidebar(editor) ? editAreaContainer(editor) : editArea('1 0 0 0')
      ]
    });
    $_4vlujeu4jkbnbatb.setUiContainer(editor, panel);
      ...
      resizeHandleCtrl = {
        ...
        onResize: function (e) {
          if (getResize(editor) === 'both') {
            $_49qzggubjkbnbaza.resizeTo(editor, startSize.width + e.deltaX, startSize.height + e.deltaY);
          } else {
            $_49qzggubjkbnbaza.resizeTo(editor, null, startSize.height + e.deltaY);
          }
        }
      };
    }
    ...
    $_cvdl8utzjkbnbas5.fireBeforeRenderUI(editor);
    ...
    $_2023mu0jkbnbasc.addKeys(editor, panel);
    $_6mlm52u1jkbnbasr.addContextualToolbars(editor);
    return {
      iframeContainer: panel.find('#iframe')[0].getEl(),
      editorContainer: panel.getEl()
    };
  };
  var $_13spb2tvjkbnbar9 = { render: render };
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_4vlujeu4jkbnbatb.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_4vlujeu4jkbnbatb.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_bmkd7oukjkbnbb1b = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_4vlujeu4jkbnbatb.getUiContainer(self$$1);
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_32pvhjuqjkbnbb3r.parseBox(settings.border);
      self$$1.paddingBox = $_32pvhjuqjkbnbb3r.parseBox(settings.padding);
      self$$1.marginBox = $_32pvhjuqjkbnbb3r.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_4vlujeu4jkbnbatb.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_32pvhjuqjkbnbb3r.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_32pvhjuqjkbnbb3r.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_32pvhjuqjkbnbb3r.measureBox(elm, 'margin');
  ...
  var render$1 = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM.styleSheetLoader.load(args.skinUiCss, $_3uvjp7uejkbnbazm.fireSkinLoaded(editor));
    } else {
      $_3uvjp7uejkbnbazm.fireSkinLoaded(editor)();
    }
    return {};
  };
  var $_19zyikufjkbnbazx = { render: render$1 };
  ...
  var $_axno8vv2jkbnbb63 = { setup: setup };
  ...
  var renderUI = function (editor, theme, args) {
    ...
    $_axno8vv2jkbnbb63.setup(editor, theme);
    return isInline(editor) ? $_19zyikufjkbnbazx.render(editor, theme, args) : $_13spb2tvjkbnbar9.render(editor, theme, args);
  };
  var $_eambxqtrjkbnbapr = { renderUI: renderUI };

  var Tooltip = Control$1.extend({
    Mixins: [$_bmkd7oukjkbnbb1b],
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_4vlujeu4jkbnbatb.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_32pvhjuqjkbnbb3r.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_32pvhjuqjkbnbb3r.parseBox('0');
  ...
  var get = function (editor) {
    var renderUI = function (args) {
      return $_eambxqtrjkbnbapr.renderUI(editor, this, args);
    };
    var resizeTo = function (w, h) {
      return $_49qzggubjkbnbaza.resizeTo(editor, w, h);
    };
    var resizeBy = function (dw, dh) {
      return $_49qzggubjkbnbaza.resizeBy(editor, dw, dh);
    };
  ...
  var isComment = function (element) {
    return type(element) === $_80s5mzw5jkbnbbhc.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_80s5mzw5jkbnbbhc.ELEMENT);
  var isText = isType$1($_80s5mzw5jkbnbbhc.TEXT);
  var isDocument = isType$1($_80s5mzw5jkbnbbhc.DOCUMENT);
  var $_68escaw4jkbnbbh9 = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_68escaw4jkbnbbh9.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_4jbix4wcjkbnbbki = { toArray: toArray };
  ...
  var $_crpmdwwfjkbnbblk = { getOrDie: getOrDie };

  var node = function () {
    var f = $_crpmdwwfjkbnbblk.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_e3wybfwljkbnbbmb.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_e3wybfwljkbnbbmb.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_e3wybfwljkbnbbmb.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_9zr5nnwpjkbnbbn0 = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_9zr5nnwpjkbnbbn0.browsers();
    var oses = $_9zr5nnwpjkbnbbn0.oses();
    var browser = $_bikb0nwojkbnbbmt.detectBrowser(browsers, userAgent).fold($_e7uy26wkjkbnbbm5.unknown, $_e7uy26wkjkbnbbm5.nu);
    var os = $_bikb0nwojkbnbbmt.detectOs(oses, userAgent).fold($_exdaj5wmjkbnbbme.unknown, $_exdaj5wmjkbnbbme.nu);
  ...
  var $_48gxlbwjjkbnbbm2 = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_48gxlbwjjkbnbbm2.detect(userAgent);
  });
  var $_ebnet9wijkbnbblw = { detect: detect$3 };

  var ELEMENT = $_80s5mzw5jkbnbbhc.ELEMENT;
  var DOCUMENT = $_80s5mzw5jkbnbbhc.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_ax61n5wejkbnbbli.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_ebnet9wijkbnbblw.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_fc49n4wdjkbnbbkl = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_26mdl5wtjkbnbbnl.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_fc49n4wdjkbnbbkl.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_fc49n4wdjkbnbbkl.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_4jbix4wcjkbnbbki.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_4jbix4wcjkbnbbki.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_816g9cw2jkbnbbgv.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_g8fwfdw6jkbnbbhk.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_g8fwfdw6jkbnbbhk.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_g8fwfdw6jkbnbbhk.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_g8fwfdw6jkbnbbhk.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_26mdl5wtjkbnbbnl.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_1ttzs1w1jkbnbbgk.ancestors(scope, function (e) {
      return $_26mdl5wtjkbnbbnl.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_1ttzs1w1jkbnbbgk.siblings(scope, function (e) {
      return $_26mdl5wtjkbnbbnl.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_1ttzs1w1jkbnbbgk.children(scope, function (e) {
      return $_26mdl5wtjkbnbbnl.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_26mdl5wtjkbnbbnl.all(selector, scope);
  };
  var $_4znyb2w0jkbnbbgg = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_4znyb2w0jkbnbbgg.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_dv76wivxjkbnbbeo = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_dv76wivxjkbnbbeo.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_816g9cw2jkbnbbgv.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_fc49n4wdjkbnbbkl.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_26mdl5wtjkbnbbnl.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_evli6twzjkbnbbor.ancestor(scope, function (e) {
      return $_26mdl5wtjkbnbbnl.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_evli6twzjkbnbbor.sibling(scope, function (e) {
      return $_26mdl5wtjkbnbbnl.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_evli6twzjkbnbbor.child(scope, function (e) {
      return $_26mdl5wtjkbnbbnl.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_26mdl5wtjkbnbbnl.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_26mdl5wtjkbnbbnl.is, ancestor$1, scope, selector, isRoot);
  };
  var $_1uszlvwyjkbnbboo = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_9tpipvx1jkbnbbpm = { register: register };
  ...
  var $_by8wf2x3jkbnbbpt = { register: register$1 };
  ...
  var $_4zpootx4jkbnbbpx = { register: register$2 };
  ...
  var $_amfa2px5jkbnbbq1 = { register: register$3 };
  ...
  var $_amtrv3x6jkbnbbq7 = { register: register$4 };
  ...
  var $_j39dyx7jkbnbbqg = { register: register$5 };
  ...
  var $_b3o245x8jkbnbbqo = { register: register$6 };
  ...
  var $_c3508mx9jkbnbbqt = { register: register$7 };
  ...
  var $_81unp7xajkbnbbqw = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$8.container = $_1uszlvwyjkbnbboo.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup$1 = function (editor) {
    ...
    setupEnvironment();
    $_amtrv3x6jkbnbbq7.register(editor);
    $_9tpipvx1jkbnbbpm.register(editor);
    $_b3o245x8jkbnbbqo.register(editor);
    $_c3508mx9jkbnbbqt.register(editor);
    $_4zpootx4jkbnbbpx.register(editor);
    $_by8wf2x3jkbnbbpt.register(editor);
    $_amfa2px5jkbnbbq1.register(editor);
    $_81unp7xajkbnbbqw.register(editor);
    $_j39dyx7jkbnbbqg.register(editor);
  };
  var $_9y30cpwxjkbnbboe = { setup: setup$1 };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_aiz8fbuxjkbnbb4u,
      Control: Control$1,
      Factory: global$4,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_90qoaquzjkbnbb5c,
      Panel: Panel,
      Movable: $_bmkd7oukjkbnbb1b,
      Resizable: $_bjvlkgv1jkbnbb5z,
      ...
      FormatControls: $_9y30cpwxjkbnbboe,
  ...
  global.add('modern', function (editor) {
    $_9y30cpwxjkbnbboe.setup(editor);
    return $_fp7euptqjkbnbapn.get(editor);
  });
  function Theme () {
  }
